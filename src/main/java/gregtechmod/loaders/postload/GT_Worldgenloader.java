...
public class GT_Worldgenloader implements Runnable {
    ...
    public void run() {
        ...
        // new GT_Worldgen_Boulder ("Overworld.Boulder.BlackGranite_Small" , true , GregTech_API.sBlockList[5].blockID,
        // 0, 0, 1, 30, 1, 0, 120, null, true);
        // new GT_Worldgen_Boulder ("Overworld.Boulder.BlackGranite_Medium" , true , GregTech_API.sBlockList[5].blockID,
        // 0, 0, 1, 40, 2, 0, 120, null, true);
        // new GT_Worldgen_Boulder ("Overworld.Boulder.BlackGranite_Large" , true , GregTech_API.sBlockList[5].blockID,
        // 0, 0, 1, 50, 4, 0, 120, null, true);

        // new GT_Worldgen_Boulder ("Overworld.Boulder.RedGranite_Small" , true , GregTech_API.sBlockList[5].blockID, 8,
        // 0, 1, 30, 1, 0, 120, null, true);
        // new GT_Worldgen_Boulder ("Overworld.Boulder.RedGranite_Medium" , true , GregTech_API.sBlockList[5].blockID,
        // 8, 0, 1, 50, 2, 0, 120, null, true);
        // new GT_Worldgen_Boulder ("Overworld.Boulder.RedGranite_Large" , true , GregTech_API.sBlockList[5].blockID, 8,
        // 0, 1, 60, 4, 0, 120, null, true);

        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.BlackGranite_Tiny",
            true,
            GregTech_API.sBlockList[5],
            0,
            0,
            1,
            50,
            ...
            null,
            false,
            new Block[] { tblock, tblock, tblock },
            new int[] { 2, 9, 10 },
            new int[] { 20000, 2500, 15000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.BlackGranite_Small",
            true,
            GregTech_API.sBlockList[5],
            0,
            0,
            ...
            new int[] { 20000, 2500, 15000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.BlackGranite_Medium",
            true,
            GregTech_API.sBlockList[5],
            0,
            0,
            ...
            new int[] { 20000, 2500, 15000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.BlackGranite_Large",
            true,
            GregTech_API.sBlockList[5],
            0,
            0,
            ...
            new int[] { 20000, 2500, 15000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.BlackGranite_Huge",
            true,
            GregTech_API.sBlockList[5],
            0,
            0,
        ...
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.RedGranite_Tiny",
            true,
            GregTech_API.sBlockList[5],
            8,
            0,
            ...
            new Block[] { tblock, tblock, tblock },
            new int[] { 7, 8, 13 },
            new int[] { 20000, 2000, 5000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.RedGranite_Small",
            true,
            GregTech_API.sBlockList[5],
            8,
            0,
            ...
            new int[] { 20000, 2000, 5000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.RedGranite_Medium",
            true,
            GregTech_API.sBlockList[5],
            8,
            0,
            ...
            new int[] { 20000, 2000, 5000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.RedGranite_Large",
            true,
            GregTech_API.sBlockList[5],
            8,
            0,
            ...
            new int[] { 20000, 2000, 5000 });
        new GT_Worldgen_Stone_Ore_SingleBlock(
            "Overworld.Layer.RedGranite_Huge",
            true,
            GregTech_API.sBlockList[5],
            8,
            0,
        ...
        new GT_Worldgen_Ore_SingleBlock(
            "Overworld.Ore.Ruby",
            true,
            tblock,
            3,
            ...
            0,
            32,
            GregTech_API.sRubyList,
            false);

        new GT_Worldgen_Ore_SingleBlock(
            "Overworld.Ore.Sapphire",
            true,
            tblock,
            4,
            0,
            ...
            0,
            32,
            GregTech_API.sSapphireList,
            false);

        new GT_Worldgen_Ore_Normal(
            "Overworld.Ore.Bauxite",
            true,
            tblock,
            5,
            0,
            ...
            32,
            80,
            GregTech_API.sBauxiteList,
            false);
        new GT_Worldgen_Ore_Normal(
            "Overworld.Ore.Bauxite_High",
            true,
            tblock,
            5,
            0,
        ...
        new GT_Worldgen_Ore_Normal(
            ...
            32,
            70,
            GregTech_API.sTetrahedriteList,
            false);
        new GT_Worldgen_Ore_Normal(
            "Overworld.Ore.Tetrahedrite_High",
            true,
            tblock,
            13,
            0,
        ...
        new GT_Worldgen_Ore_Normal(
            ...
            32,
            70,
            GregTech_API.sCassiteriteList,
            false);
        new GT_Worldgen_Ore_Normal(
            "Overworld.Ore.Cassiterite_High",
            true,
            tblock,
            14,
            0,
        ...
        new GT_Worldgen_Ore_Normal(
            ...
            10,
            32,
            GregTech_API.sNickelList,
            false);

        new GT_Worldgen_Ore_SingleBlock_UnderLava(
            "Overworld.Ore.Sphalerite",
            true,
            tblock,
            8,
            0,
