    ...
    public void run() {
        ...
        try {
            new GT_BaseCrop(
                ...
                "gt_crops.indigo",
                "Eloraam",
                GT_Items.Crop_Drop_Indigo.get(1),
                null,
                GT_Items.Crop_Drop_Indigo.get(4),
                2,
                4,
                0,
                1,
            ...
            new GT_BaseCrop(
                ...
                "gt_crops.oilberries",
                "Spacetoad",
                GT_Items.Crop_Drop_OilBerry.get(1),
                null,
                null,
                9,
                4,
            ...
            new GT_BaseCrop(
                127,
                "gt_crops.bobsyeruncleranks",
                "GenerikB",
                GT_Items.Crop_Drop_BobsYerUncleRanks.get(1),
            ...
            new GT_BaseCrop(
                ...
                "gt_crops.diareed",
                "Direwolf20",
                GT_OreDictUnificator.get("dustSmallDiamond", 1),
            ...
            new GT_BaseCrop(
                ...
                "gt_crops.withereed",
                "CovertJaguar",
                GT_OreDictUnificator.get("dustCoal", 1),
            ...
            new GT_BaseCrop(
                133,
                "gt_crops.corpseplant",
                "Mr. Kenny",
                new ItemStack(Items.rotten_flesh, 1),
                new ItemStack[] { new ItemStack(Items.dye, 1, 15), new ItemStack(Items.dye, 1, 15),
            ...
            new GT_BaseCrop(
                134,
                "gt_crops.creeperweed",
                "General Spaz",
                GT_OreDictUnificator.get("dustGunpowder", 1),
                null,
                null,
                7,
                4,
            ...
            new GT_BaseCrop(
                ...
                "gt_crops.enderbloom",
                "RichardG",
                GT_OreDictUnificator.get("dustEnderPearl", 1),
            ...
            new GT_BaseCrop(
                ...
                "gt_crops.milkwart",
                "Mr. Brain",
                GT_Items.Crop_Drop_MilkWart.get(1),
                null,
                null,
                6,
                3,
            ...
            GT_Utility.getField(tCrop = Crops.instance.getCropList()[13], "mDrop")
                .set(tCrop, GT_Items.Crop_Drop_Ferru.get(1L));
            GT_Utility.getField(tCrop = Crops.instance.getCropList()[14], "mDrop")
                .set(tCrop, GT_Items.Crop_Drop_Aurelia.get(1L));
            GT_Utility.getField(tCrop = Crops.instance.getCropList()[25], "mDrop")
                .set(tCrop, GT_Items.Crop_Drop_Coppon.get(1L));
            GT_Utility.getField(tCrop = Crops.instance.getCropList()[27], "mDrop")
                .set(tCrop, GT_Items.Crop_Drop_Plumbilia.get(1L));
            GT_Utility.getField(tCrop = Crops.instance.getCropList()[28], "mDrop")
                .set(tCrop, GT_Items.Crop_Drop_Argentia.get(1L));
        } catch (Throwable e) {
