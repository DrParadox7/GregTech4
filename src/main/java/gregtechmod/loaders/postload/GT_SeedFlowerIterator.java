...
public class GT_SeedFlowerIterator implements Runnable {
    ...
    public void run() {
        GT_Log.log.info(
            "Iterating through the Seed-List of ForgeHooks, with a brilliant and 100% Reflection-free Method, to add Recipes for gaining Seed Oil from Seeds.");
        boolean temp = false;
        try {
                ...
                if (tSeed != null) {
                    if (tLiquid != null && GT_ModHandler.addSqueezerRecipe(tSeed, tLiquid, 15)) {
                        ...
                        RecipeMaps.CENTRIFUGE.factory()
                            ...
                            .output(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SeedOil))
                            .buildAndRegister();
                    }
                }
            }
            ...
            GT_Log.log.info(
                "Iterating through the Grass-Flower-List of ForgeHooks, with a brilliant and 100% Reflection-free Method, to add Extractor Recipes for gaining more Dye from Flowers and also Compression Recipes for Plantballs.");
            ...
            while (tWorld.mRandom.mIterationStep > 1) {
                try {
                    ...
                    ItemDye.applyBonemeal(
                        new ItemStack(Items.dye, 64, 0),
                        tWorld,
                        24,
                        64,
                        24,
                        new EntityPlayer(tWorld, new GameProfile(UUID.randomUUID(), "ILYAPIDOR")) {

                            @Override
                            public ChunkCoordinates getPlayerCoordinates() {
                                return new ChunkCoordinates(24, 64, 24);
                            }
                    ...
                    if (tWorld.mLastSetBlock != null) {
                        ...
                        GT_ModHandler.addCompressionRecipe(
                            GT_Utility.copy(8, tWorld.mLastSetBlock),
                            GT_ModHandler.getIC2Item("plantBall", 1));
                    }
                } catch (Throwable e) {
                    GT_Log.log.warn(
                        "Minor Bug: Wasn't able to simulate the planting of a Flower with Bonemeal, to add Extractor Recipe for Dye:\n");
                    GT_Log.log.catching(e);
                }
            }
        } catch (Throwable e) {
            GT_Log.log.warn(
                "failed to iterate somehow, maybe it's your Forge Version causing it. But it's not that important\n");
            GT_Log.log.catching(e);
        }
        ...
        if (temp) {
            ...
            RecipeMaps.CENTRIFUGE.factory()
                ...
                .duration(200)
                .setShaped(true)
                .input(new ItemStack(Items.melon_seeds, 64, 0))
                .input(GT_Items.Cell_Empty.get(1))
                .output(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SeedOil))
                .buildAndRegister();
            RecipeMaps.CENTRIFUGE.factory()
                ...
                .duration(200)
                .setShaped(true)
                .input(new ItemStack(Items.pumpkin_seeds, 64, 0))
                .input(GT_Items.Cell_Empty.get(1))
                .output(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SeedOil))
                .buildAndRegister();
            RecipeMaps.CENTRIFUGE.factory()
                ...
                .duration(200)
                .setShaped(true)
                .input(new ItemStack(Items.wheat_seeds, 64, 0))
                .input(GT_Items.Cell_Empty.get(1))
                .output(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SeedOil))
                .buildAndRegister();
        }
