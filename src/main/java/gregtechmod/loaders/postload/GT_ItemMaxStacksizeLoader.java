...
public class GT_ItemMaxStacksizeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_ModHandler.getIC2Item("overclockerUpgrade", 1)
            .getItem()
            .setMaxStackSize(GT_Mod.sUpgradeCount);
        ...
        if (GT_Mod.sBlockStackSize < 64) {
            Item.getItemFromBlock(Blocks.stone_slab)
                .setMaxStackSize(GT_Mod.sBlockStackSize);
            ...
            Item.getItemFromBlock(Blocks.redstone_lamp)
                .setMaxStackSize(GT_Mod.sBlockStackSize);
            Item.getItemFromBlock(Blocks.lit_redstone_lamp)
                .setMaxStackSize(GT_Mod.sBlockStackSize);
