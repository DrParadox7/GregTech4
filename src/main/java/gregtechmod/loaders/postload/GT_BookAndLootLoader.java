...
public class GT_BookAndLootLoader implements Runnable {
    ...
    public void run() {
        ...
        if (GT_Mod.sBookDungeonLoot) {
            ItemStack tStack;
            tStack = GT_Utility.getWrittenBook(
            ...
            if (tStack != null) {
                ChestGenHooks.addItem(
                    ...
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 2));
                ChestGenHooks.addItem(
                ...
                ChestGenHooks.addItem(
                    ...
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 20));
                tStack = null;
            }
            ...
            if (tStack != null) {
                ChestGenHooks.addItem(
                    ChestGenHooks.BONUS_CHEST,
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 1));
                ChestGenHooks.addItem(
                    ChestGenHooks.DUNGEON_CHEST,
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 1));
                ChestGenHooks.addItem(
                ...
                ChestGenHooks.addItem(
                    ChestGenHooks.STRONGHOLD_LIBRARY,
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 15));
                tStack = null;
            }
            ...
            if (tStack != null) {
                ...
                ChestGenHooks.addItem(
                    ChestGenHooks.STRONGHOLD_LIBRARY,
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 10));
                tStack = null;
            }
            ...
            if (tStack != null) {
                ...
                ChestGenHooks.addItem(
                    ...
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 3));
                ChestGenHooks.addItem(
                    ChestGenHooks.PYRAMID_JUNGLE_CHEST,
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 5));
                ChestGenHooks.addItem(
                    ChestGenHooks.STRONGHOLD_LIBRARY,
                    new WeightedRandomChestContent(GT_Utility.copy(tStack), 1, 1, 20));
                tStack = null;
            ...
            tStack = GT_Utility.getWrittenBook(
                "Greg-OS Manual II",
                "Gregorius Techneticies",
                new String[] { "List of Logic Circuits",
            ...
            tStack = GT_Utility.getWrittenBook(
                ...
                "Mario",
                new String[] { "It's me Mario, and I will explain you how to use Pipes.",
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.BONUS_CHEST,
            new WeightedRandomChestContent(GT_Items.Tool_Sword_Flint.get(1), 1, 1, 1));
        ChestGenHooks.addItem(
            ChestGenHooks.BONUS_CHEST,
            new WeightedRandomChestContent(GT_Items.Tool_Pickaxe_Flint.get(1), 1, 1, 1));
        ChestGenHooks.addItem(
            ChestGenHooks.BONUS_CHEST,
            new WeightedRandomChestContent(GT_Items.Tool_Shovel_Flint.get(1), 1, 1, 1));
        ChestGenHooks.addItem(
            ChestGenHooks.BONUS_CHEST,
            new WeightedRandomChestContent(GT_Items.Tool_Axe_Flint.get(1), 1, 1, 1));
        ChestGenHooks.addItem(
            ChestGenHooks.BONUS_CHEST,
            new WeightedRandomChestContent(GT_Items.Bottle_Purple_Drink.get(1), 8, 16, 2));

        ChestGenHooks
            .addItem(ChestGenHooks.DUNGEON_CHEST, new WeightedRandomChestContent(GT_Items.Spray_Ice.get(1), 1, 1, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_Items.Spray_Pepper.get(1), 1, 1, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_Items.Bottle_Purple_Drink.get(1), 8, 16, 80));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Lead, 1), 1, 6, 30));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1), 1, 6, 60));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 1), 1, 6, 60));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Emerald, 1), 1, 6, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Ruby, 1), 1, 6, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Sapphire, 1), 1, 6, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GreenSapphire, 1),
                1,
                6,
                20));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Olivine, 1), 1, 6, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GarnetRed, 1),
                1,
                6,
                40));
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GarnetYellow, 1),
                1,
                6,
                40));
        ChestGenHooks.addItem(
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.DUNGEON_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 1), 1, 3, 40));
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_DESERT_CHEST,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Cooperite, 1),
                2,
                8,
                4));
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_DESERT_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Ruby, 1), 2, 8, 2));
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_DESERT_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Sapphire, 1), 2, 8, 2));
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_DESERT_CHEST,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GreenSapphire, 1),
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_DESERT_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Olivine, 1), 2, 8, 2));
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_DESERT_CHEST,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GarnetRed, 1), 2, 8, 4));
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_DESERT_CHEST,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GarnetYellow, 1),
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_JUNGLE_CHEST,
            new WeightedRandomChestContent(GT_Items.Coin_Gold_Ancient.get(1), 16, 64, 10));
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_JUNGLE_CHEST,
            new WeightedRandomChestContent(GT_Items.ZPM.getWithCharge(1, Integer.MAX_VALUE), 1, 1, 1));
        ChestGenHooks.addItem(
            ChestGenHooks.PYRAMID_JUNGLE_CHEST,
            new WeightedRandomChestContent(
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_Items.Spray_Ice.get(1), 1, 1, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silver, 1), 1, 4, 12));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Lead, 1), 1, 4, 3));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1), 1, 4, 6));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 1), 1, 4, 6));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Emerald, 1), 1, 4, 2));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Ruby, 1), 1, 4, 2));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Sapphire, 1), 1, 4, 2));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GreenSapphire, 1),
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Olivine, 1), 1, 4, 2));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GarnetRed, 1), 1, 4, 4));
        ChestGenHooks.addItem(
            ChestGenHooks.MINESHAFT_CORRIDOR,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GarnetYellow, 1),
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.VILLAGE_BLACKSMITH,
            new WeightedRandomChestContent(GT_Items.McGuffium_239.get(1), 1, 1, 1));
        ChestGenHooks.addItem(
            ChestGenHooks.VILLAGE_BLACKSMITH,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 1), 1, 4, 6));
        ChestGenHooks.addItem(
            ChestGenHooks.VILLAGE_BLACKSMITH,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Manganese, 1),
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.VILLAGE_BLACKSMITH,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1), 4, 12, 12));
        ChestGenHooks.addItem(
            ChestGenHooks.VILLAGE_BLACKSMITH,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 1),
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.VILLAGE_BLACKSMITH,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Brass, 1), 4, 12, 12));

        ChestGenHooks.addItem(
            ChestGenHooks.STRONGHOLD_CROSSING,
            new WeightedRandomChestContent(GT_Items.McGuffium_239.get(1), 1, 1, 10));
        ChestGenHooks.addItem(
            ChestGenHooks.STRONGHOLD_CROSSING,
            new WeightedRandomChestContent(GT_Items.Spray_Pepper.get(1), 1, 1, 20));
        ChestGenHooks.addItem(
            ChestGenHooks.STRONGHOLD_CROSSING,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Chrome, 1), 1, 8, 6));
        ChestGenHooks.addItem(
            ChestGenHooks.STRONGHOLD_CROSSING,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Manganese, 1),
        ...
        ChestGenHooks.addItem(
            ChestGenHooks.STRONGHOLD_CROSSING,
            new WeightedRandomChestContent(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1), 8, 32, 12));
        ChestGenHooks.addItem(
            ChestGenHooks.STRONGHOLD_CROSSING,
            new WeightedRandomChestContent(
                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 1),
