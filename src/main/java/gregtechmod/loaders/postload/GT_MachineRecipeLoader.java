...
public class GT_MachineRecipeLoader implements Runnable
{
    ...
    public void run() {
        ...
        if(!gregtechmod.GT_Mod.sMinimalItemGeneration) {
            ...
            //RecipeMaps.BLAST_FURNACE.factory().minTemperature(1700).EUt(120).duration(640).input(OrePrefixes.gem, Materials.Ilmenite, 2).outputs(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 1L), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Titanium, 1L)).buildAndRegister();
            ...
            //RecipeMaps.BLAST_FURNACE.factory().minTemperature(1000).EUt(120).duration(320).input(OrePrefixes.gem, Materials.Magnetite, 2).outputs(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 2)).buildAndRegister();
        }
        //RecipeMaps.BLAST_FURNACE.factory().minTemperature(1500).EUt(120).duration(320).input(OrePrefixes.gem, Materials.Galena, 2).outputs(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silver, 1L), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Lead, 1L)).buildAndRegister();
        ...
        RecipeMaps.CANNING.factory().EUt(2).duration( 100).input(OrePrefixes.cell, Materials.SulfuricAcid		,  1).input(GT_Items.Battery_Hull_LV.get(1)).outputs(GT_Items.Battery_SU_LV_SulfuricAcid			.getWithCharge(1, Integer.MAX_VALUE), GT_Items.Cell_Empty.get( 1)).buildAndRegister();
...
//        RecipeMaps.CANINNING.factory().EUt(1).duration(50).inputs(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.BioFuel, 1L), GT_Items.Fuel_Can_Plastic_Empty.get(1L)).outputs(GT_ModHandler.setFuelValue(GT_Items.Fuel_Can_Plastic_Filled.get(1L), (short)(Materials.BioFuel.mFuelPower * 400)), GT_Items.Cell_Empty.get(1L)).buildAndRegister();
        ...
        if (!OreDictionary.getOres("dustQuartzite").isEmpty())
        ...
        if (!OreDictionary.getOres("dustUranite").isEmpty()) {
        ...
        if (!OreDictionary.getOres("dustCalcium").isEmpty()) {
        ...
        if (!OreDictionary.getOres("dustCalcite").isEmpty()) {
        ...
        if (!OreDictionary.getOres("dustApatite").isEmpty()) {
        ...
        if (!OreDictionary.getOres("dustGlauconite").isEmpty()) {
        ...
        RecipeMaps.ASSEMBLING.factory().EUt(16).duration( 800).input(OrePrefixes.plate, Materials.Aluminium, 1).input("craftingTableWood", 1).output(GregTech_API.getGregTechComponent(64, 1)).buildAndRegister();
        ...
        RecipeMaps.ASSEMBLING.factory().EUt(16).duration( 800).input(OrePrefixes.plate, Materials.Iron, 1).input("craftingTableWood", 1).output(GregTech_API.getGregTechComponent(64, 1)).buildAndRegister();
...
//        RecipeMaps.ASSEMBLING.factory().EUt(16).duration(100).inputs(GT_OreDictUnificator.get(OrePrefixes.toolHeadScrewdriver, Materials.TungstenSteel, 1L), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 1L)).output(GT_Items.Tool_Screwdriver_TungstenSteel.getUndamaged(1L)).buildAndRegister();
        ...
        if (!OreDictionary.getOres("dustPlutonium241").isEmpty())
