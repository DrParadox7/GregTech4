...
public class GT_CraftingRecipeLoader implements Runnable {
	...
	public void run() {
	    ...
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Bronze_Medium			.get(6), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.Bronze), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Steel_Medium			.get(6), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.Steel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_StainlessSteel_Medium	.get(6), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.StainlessSteel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_TungstenSteel_Medium	.get(6), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.TungstenSteel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Brass_Medium			.get(6), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.Brass), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Electrum_Medium		.get(6), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.Electrum), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Cooperite_Medium		.get(6), false, true, new Object[] {"PPP", "W H", "PPP", 'P', OrePrefixes.plate.get(Materials.Cooperite), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Bronze_Small			.get(18), false, true, new Object[] {"PWP", "P P", "PHP", 'P', OrePrefixes.plate.get(Materials.Bronze), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Steel_Small			.get(18), false, true, new Object[] {"PWP", "P P", "PHP", 'P', OrePrefixes.plate.get(Materials.Steel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_StainlessSteel_Small	.get(18), false, true, new Object[] {"PWP", "P P", "PHP", 'P', OrePrefixes.plate.get(Materials.StainlessSteel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_TungstenSteel_Small	.get(18), false, true, new Object[] {"PWP", "P P", "PHP", 'P', OrePrefixes.plate.get(Materials.TungstenSteel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Bronze_Large			.get(3), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.Bronze), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Steel_Large			.get(3), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.Steel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_StainlessSteel_Large	.get(3), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.StainlessSteel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_TungstenSteel_Large	.get(3), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.TungstenSteel), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Brass_Large			.get(3), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.Brass), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Electrum_Large		.get(3), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.Electrum), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
	    GT_ModHandler.addCraftingRecipe(GT_Items.Pipe_Cooperite_Large		.get(3), false, true, new Object[] {"PHP", "P P", "PWP", 'P', OrePrefixes.plate.get(Materials.Cooperite), 'H', GT_ToolDictNames.craftingToolHardHammer, 'W', GT_ToolDictNames.craftingToolWrench});
    	...
    	if (GregTech_API.sRecipeFile.get(GT_ConfigCategories.Recipes.gregtechrecipes, "tesseracts", true)) {
    		GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1, 84), new Object[] {"TCT", "CEC", "TMT", 'C', OrePrefixes.circuit.get(Materials.Master)	, 'M', OrePrefixes.computer.get(Materials.Master)	, 'E', GregTech_API.sRecipeFile.get(GT_ConfigCategories.Recipes.disabledrecipes, "enderchest", false)?new ItemStack(Items.ender_eye, 1):new ItemStack(Blocks.ender_chest, 1), 'T', OrePrefixes.plate.get(Materials.Titanium)});
    		GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1, 85), new Object[] {"TCT", "CEC", "TMT", 'C', OrePrefixes.circuit.get(Materials.Elite)	, 'M', GT_OreDictNames.craftingRawMachineTier02		, 'E', GregTech_API.sRecipeFile.get(GT_ConfigCategories.Recipes.disabledrecipes, "enderchest", false)?new ItemStack(Items.ender_eye, 1):new ItemStack(Blocks.ender_chest, 1), 'T', OrePrefixes.plate.get(Materials.Titanium)});
    	}
    	...
    	if (GregTech_API.sRecipeFile.get(GT_ConfigCategories.Recipes.gregtechrecipes, "electricautocraftingtable", true)) {
    		GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1, 16), new Object[] {"GBG", "CTC", "GAG", 'B', OrePrefixes.battery.get(Materials.Basic), 'A', GT_OreDictNames.craftingRawMachineTier02	, 'C', OrePrefixes.circuit.get(Materials.Advanced), 'T', "craftingTableWood", 'G', OrePrefixes.plate.get(Materials.Electrum)});
    	}
    	...
    	GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 4,70), new Object[] {"WWW", "A A", "WWW", 'W', "plankWood", 'A', OrePrefixes.plate.get(Materials.Wood)});
    	GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 4,71), new Object[] {"III", "A A", "III", 'I', OrePrefixes.plate.get(Materials.Iron), 'A', OrePrefixes.plate.get(Materials.Iron)});
    	...
    	GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1,112), new Object[] {"PWP", "PMP", "PCP", 'P', OrePrefixes.plate.get(Materials.Iron), 'C', OrePrefixes.circuit.get(Materials.Advanced), 'W', "craftingTableWood", 'M', GT_OreDictNames.craftingRawMachineTier01});
    	GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1,112), new Object[] {"PWP", "PMP", "PCP", 'P', OrePrefixes.plate.get(Materials.Aluminium)  , 'C', OrePrefixes.circuit.get(Materials.Advanced), 'W', "craftingTableWood", 'M', GT_OreDictNames.craftingRawMachineTier01});
    	
    	GT_ModHandler.addCraftingRecipe(new ItemStack(GregTech_API.sBlockList[1], 1,128), new Object[] {"PWP", "PMP", "PPP", 'P', OrePrefixes.plate.get(Materials.Bronze), 'W', "craftingTableWood", 'M', GT_OreDictNames.craftingRawMachineTier00});
