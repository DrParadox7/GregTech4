            ...
            if (this.isExecutable(aPrefix, this.getMaterial(aPrefix, entry))) {
                if (entry.oreDictName.equals(GT_OreDictNames.craftingRedstoneTorch.toString())) {
                    ...
                    RecipeMaps.ASSEMBLING.factory()
                        ...
                        .output(GregTech_API.getGregTechComponent(87, 1))
                        .buildAndRegister();
                    ...
                    RecipeMaps.ASSEMBLING.factory()
                        ...
                        .output(new ItemStack(GregTech_API.sBlockList[1], 1, 66))
                        .buildAndRegister();
                    RecipeMaps.ASSEMBLING.factory()
                        .EUt(1)
                        .duration(800)
                        ...
                        .output(new ItemStack(GregTech_API.sBlockList[1], 1, 67))
                        .buildAndRegister();
                    RecipeMaps.ASSEMBLING.factory()
                        .EUt(2)
                        .duration(1600)
                        ...
                        .output(GT_ModHandler.getIC2Item("solarPanel", 1))
                        .buildAndRegister();
                    ItemStack machineBlock = new ItemStack(GregTech_API.sBlockList[1], 1, 79);
                    List<ItemStack> filtered = entry.ores.stream()
                        .filter(s -> !s.isItemEqual(machineBlock))
                    ...
                    RecipeMaps.ASSEMBLING.factory()
                        ...
                        .output(new ItemStack(GregTech_API.sBlockList[1], 1, 79))
                        .buildAndRegister();
                    ...
                    RecipeMaps.ASSEMBLING.factory()
                        ...
                        .duration(3200)
                        .input(RecipeEntry.fromStacks(entry.ores, Match.DAMAGE))
                        .input(OrePrefixes.gearGt, Materials.TungstenSteel, 1)
                        .output(GregTech_API.getGregTechComponent(25, 1))
                        .buildAndRegister();
                    ...
                    RecipeMaps.ASSEMBLING.factory()
                        ...
                        .output(GT_Items.Battery_Hull_MV.get(1))
                        .buildAndRegister();
                    RecipeMaps.ASSEMBLING.factory()
                        .EUt(1)
                        .duration(800)
                        .input(RecipeEntry.fromStacks(3, entry.ores, Match.DAMAGE))
                        .input(GT_Items.Circuit_Board_Basic.get(1))
                    ...
                    RecipeMaps.ASSEMBLING.factory()
                        ...
                        .output(GT_ModHandler.getIC2Item("frequencyTransmitter", 1L))
                        .buildAndRegister();
                    ...
                    RecipeMaps.ASSEMBLING.factory()
                        ...
                        .output(GT_Items.Battery_Hull_LV.get(1))
                        .buildAndRegister();
                    RecipeMaps.ASSEMBLING.factory()
                        .EUt(1)
                        .duration(800)
