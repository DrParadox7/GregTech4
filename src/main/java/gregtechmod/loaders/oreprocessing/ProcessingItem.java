            ...
            if (this.isExecutable(aPrefix, this.getMaterial(aPrefix, entry))) {
                for (ItemStack aStack : entry.ores) {
                    ...
                    switch (entry.oreDictName) {
                        ...
                        default:
                            if (GregTech_API.OREDICT_DEBUG_MODE) GT_Log.log.warn(
                                "Item Name: " + entry.oreDictName
                                    + " !!!Unknown Item detected!!! Please report to GregTech Intergalactical for additional compatiblity. This is not an Error, it\'s just an Information.");
                    }
                }
            }
        }
