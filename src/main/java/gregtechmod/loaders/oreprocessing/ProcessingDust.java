            ...
            if (this.isExecutable(aPrefix, aMaterial)) {
                ...
                if (GT_OreDictUnificator.get(OrePrefixes.cell, aMaterial, 1) != null) {
                    RecipeMaps.CANNING.factory()
                        ...
                        .buildAndRegister();
                    if (aMaterial != Materials.Milk) RecipeMaps.CANNING.factory()
                        .EUt(1)
                        .duration(100)
                ...
                if (aMaterial.mMaterialList.size() > 0 && (aMaterial.mExtraData & 3) != 0) {
                    ...
                    if (tList.size() > 0) {
                        if ((aMaterial.mExtraData & 1) != 0) {
                            ...
                            if (tCapsuleCount > 0) factory.input(GT_Items.Cell_Empty.get(tCapsuleCount));
                ...
                if (!aMaterial.contains(SubTag.NO_SMELTING) && tStack != null) {
                    ...
                    if (!OrePrefixes.block.isIgnored(aMaterial)
                        ...
                        for (ItemStack a : entry.ores) RecipeHandler.scheduleCraftingToRemove(
                    ...
                    if (tStack != null && !aMaterial.contains(SubTag.NO_SMELTING)) {
                        if (aMaterial.mBlastFurnaceRequired) {
                            ...
                            if (aMaterial.mBlastFurnaceTemp <= 1000) GT_ModHandler.addRCBlastFurnaceRecipe(
                                ...
                                GT_Utility.copyAmount(1, tStack),
