...
public class ProcessingShaping implements IOreRecipeRegistrator {
    ...
    public final static List<Materials> PIPES_SMALL = Arrays
        .asList(Materials.Bronze, Materials.Steel, Materials.StainlessSteel, Materials.TungstenSteel);
        ...
        for (OreDictEntry e : entries) {
            ...
            if (this.isExecutable(aPrefix, aMaterial)
                ...
                if (tAmount > 0 && tAmount <= 64 && aPrefix.mMaterialAmount % GregTech_API.MATERIAL_UNIT == 0L) {
                    ...
                    if (!sMinimalItemGeneration && (aMaterial.mTypes & 64) != 0
                    ...
                    if ((aMaterial.mTypes & 2) != 0) {
                        ...
                        if ((tItem = GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, tAmount)) != null) {
                            RecipeMaps.EXTRUDING.factory()
                                ...
                                .duration(Math.max(aMaterial.getMass() * 1 * tAmount, tAmount))
                                .input(RecipeEntry.fromStacks(1, e.ores, Match.STRICT))
                                .nonConsumable(GT_Items.Shape_Extruder_Plate.get(1))
                                .output(tItem)
                                .buildAndRegister();
                            RecipeMaps.ALLOY_SMELTING.factory()
                                .EUt(32)
                                .duration(Math.max(aMaterial.getMass() * 2 * tAmount, tAmount))
                                .input(RecipeEntry.fromStacks(2, e.ores, Match.STRICT))
                                .nonConsumable(GT_Items.Shape_Mold_Plate.get(1))
                                .output(tItem)
                                .buildAndRegister();
                        }
                        ...
                        if (tAmount * 2 <= 64
                            ...
                            RecipeMaps.EXTRUDING.factory()
                                ...
                                .duration(Math.max(aMaterial.getMass() * 2 * tAmount, tAmount))
                                .input(RecipeEntry.fromStacks(1, e.ores, Match.STRICT))
                                .nonConsumable(GT_Items.Shape_Extruder_Rod.get(1))
                                .output(tItem)
                                .buildAndRegister();
                        if (!sMinimalItemGeneration && tAmount * 8 <= 64
                            ...
                            RecipeMaps.EXTRUDING.factory()
                                ...
                                .duration(Math.max(aMaterial.getMass() * 2 * tAmount, tAmount))
                                .input(RecipeEntry.fromStacks(1, e.ores, Match.STRICT))
                                .nonConsumable(GT_Items.Shape_Extruder_Bolt.get(1))
                                .output(tItem)
                                .buildAndRegister();
                        if (!sMinimalItemGeneration && tAmount * 4 <= 64
                            ...
                            RecipeMaps.EXTRUDING.factory()
                                ...
                                .duration(Math.max(aMaterial.getMass() * 2 * tAmount, tAmount))
                                .input(RecipeEntry.fromStacks(1, e.ores, Match.STRICT))
                                .nonConsumable(GT_Items.Shape_Extruder_Ring.get(1))
                                .output(tItem)
                                .buildAndRegister();
                        if (!OrePrefixes.block.isIgnored(aMaterial)
                            ...
                            RecipeMaps.EXTRUDING.factory()
                                ...
                                .nonConsumable(GT_Items.Shape_Extruder_Block.get(1))
                                .output(tItem)
                                .buildAndRegister();

                        switch (aMaterial) {
                            case Iron:
                                if (tAmount * 6 <= 64) RecipeMaps.EXTRUDING.factory()
                                    .EUt(64)
                                    .setShaped(true)
                                    .duration(tAmount * 8)
                                    .input(RecipeEntry.fromStacks(1, e.ores, Match.STRICT))
                                ...
                                RecipeMaps.EXTRUDING.factory()
                                    ...
                                    .output(GT_ModHandler.getIC2Item("fuelRod", tAmount))
                                    .buildAndRegister();
                                break;
                            case Tin:
                                if (tAmount * 4 <= 64) RecipeMaps.EXTRUDING.factory()
                                    .EUt(64)
                                    .setShaped(true)
                                    .duration(tAmount * 3)
                                    .input(RecipeEntry.fromStacks(1, e.ores, Match.STRICT))
                                ...
                                RecipeMaps.EXTRUDING.factory()
                                    ...
                                    .input(RecipeEntry.fromStacks(2, e.ores, Match.STRICT))
                                    .nonConsumable(GT_Items.Shape_Extruder_Cell.get(1))
                                    .output(GT_Items.Cell_Empty.get(tAmount))
                                    .buildAndRegister();
                                break;
                            case SolderingAlloy:
                                RecipeMaps.EXTRUDING.factory()
                            ...
                            case Steel:
                                if (tAmount * 2 <= 64) {
                                    RecipeMaps.EXTRUDING.factory()
                                        ...
                                        .input(RecipeEntry.fromStacks(1, e.ores, Match.STRICT))
                                        .nonConsumable(GT_Items.Shape_Extruder_Casing.get(1))
                                        .output(GT_ModHandler.getIC2Item("casingadviron", (tAmount * 2)))
                                        .buildAndRegister();
                                    RecipeMaps.ALLOY_SMELTING.factory()
                                        .EUt(12)
                                        .duration(tAmount * 128)
                                        .input(RecipeEntry.fromStacks(2, e.ores, Match.STRICT))
                                        .nonConsumable(GT_Items.Shape_Mold_Casing.get(1))
                                        .output(GT_ModHandler.getIC2Item("casingadviron", (tAmount * 3)))
                                        .buildAndRegister();
                                }
                                break;
                            default:
