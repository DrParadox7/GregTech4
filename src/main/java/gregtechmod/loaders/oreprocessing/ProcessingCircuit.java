                ...
                switch (aMaterial) {
                        ...
                        RecipeHandler.executeOnFinish(() -> {
                            GameRegistry.addRecipe(
                                new GT_Shaped_Recipe(
                                    GT_Items.Circuit_Basic.get(1),
                                    new Object[] { "CCC", "SRS", "CCC", 'C',
                                        GT_OreDictNames.craftingWireCopper.toString(), 'R',
                                        OrePrefixes.plate.get(Materials.Iron), 'S',
                                        GregTech_API.sRecipeFile
                                            .get(GT_ConfigCategories.Recipes.harderrecipes, "circuitRedAlloy", true)
                                                ? OrePrefixes.plate.get(Materials.RedAlloy)
                                                : OrePrefixes.dust.get(Materials.Redstone) }));
                            GameRegistry.addRecipe(
                                new GT_Shaped_Recipe(
                                    GT_Items.Circuit_Basic.get(1),
                                    new Object[] { "CSC", "CRC", "CSC", 'C',
                                        GT_OreDictNames.craftingWireCopper.toString(), 'R',
                                        OrePrefixes.plate.get(Materials.Iron), 'S',
                                        GregTech_API.sRecipeFile
                                            .get(GT_ConfigCategories.Recipes.harderrecipes, "circuitRedAlloy", true)
                    ...
                    case Advanced:
                        RecipeHandler.executeOnFinish(() -> {
                            GameRegistry.addRecipe(
                                new GT_Shaped_Recipe(
                                    GT_Items.Circuit_Advanced.get(1),
                                    new Object[] { "SGS", "LCL", "SGS", 'C', OrePrefixes.circuit.get(Materials.Basic),
                                        'S',
                                        GregTech_API.sRecipeFile
                                            .get(GT_ConfigCategories.Recipes.harderrecipes, "circuitRedAlloy", true)
                                                ? OrePrefixes.plate.get(Materials.RedAlloy)
                                                : OrePrefixes.dust.get(Materials.Redstone),
                                        'G', OrePrefixes.dust.get(Materials.Glowstone), 'L',
                                        OrePrefixes.dust.get(Materials.Lazurite) }));
                            GameRegistry.addRecipe(
                                new GT_Shaped_Recipe(
                                    GT_Items.Circuit_Advanced.get(1),
                                    new Object[] { "SLS", "GCG", "SLS", 'C', OrePrefixes.circuit.get(Materials.Basic),
                                        'S',
                                        GregTech_API.sRecipeFile
                                            .get(GT_ConfigCategories.Recipes.harderrecipes, "circuitRedAlloy", true)
                                                ? OrePrefixes.plate.get(Materials.RedAlloy)
