        ...
        for (OreDictEntry entry : entries) {
            ...
            if (this.isExecutable(aPrefix, aMaterial)) {
                if ((aMaterial == Materials.Charcoal || aMaterial == Materials.Coal) && GregTech_API.sRecipeFile
                    ...
                    RecipeHandler.scheduleCraftingToRemove(
                        new RecipeHandler.InventoryRecipeMatcher(
                            false,
                            GT_OreDictUnificator.get(aPrefix, aMaterial),
                            null,
                            null,
                ...
                if ((aMaterial.mTypes & 4) != 0 && aMaterial.mTransparent
                    ...
                    && GT_OreDictUnificator.get(OrePrefixes.lense, aMaterial) != null) {
                ...
                if (!OrePrefixes.block.isIgnored(aMaterial)) {
                    ...
                    if (block != null) {
                        ...
                        if (!GregTech_API.sRecipeFile.get(
                            GT_ConfigCategories.Recipes.storageblockcrafting,
                            OrePrefixes.block.get(aMaterial),
                            false)) {
                            for (ItemStack b : entry.ores) {
                                if (aMaterial.mSmallBlock) {
                                    RecipeHandler.scheduleCraftingToRemove(
                                        new RecipeHandler.InventoryRecipeMatcher(false, b, b, null, b, b, null));
                                } else {
                                    RecipeHandler.scheduleCraftingToRemove(
                                        new RecipeHandler.InventoryRecipeMatcher(false, b, b, b, b, b, b, b, b, b));
                                }
                            }
                        }
                    }
