            ...
            if (this.isExecutable(aPrefix, mat) && mat == Materials.Wood) {
                if (GT_Mod.RC_loaded) {
                    ...
                    RecipeMaps.CANNING.factory()
                        .EUt(4)
                        .duration(200)
                        .input(OrePrefixes.cell, Materials.Creosote)
                        .input(RecipeEntry.fromStacks(entry.ores, Match.DAMAGE))
                ...
                for (ItemStack aStack : entry.ores) {
                    if (aStack.getItem() instanceof ItemBlock && GT_Mod.sPlankStackSize < aStack.getItem()
                        .getItemStackLimit(aStack)) {
                        aStack.getItem()
                            .setMaxStackSize(GT_Mod.sPlankStackSize);
                    }
                }
            }
        }
