        ...
        for (OreDictEntry entry : entries) {
            ...
            if (this.isExecutable(aPrefix, aMaterial)) {
                ...
                RecipeHandler.executeOnFinish(() -> {
                    ItemStack tinyDust = GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L);
                    if (tinyDust != null) GameRegistry.addRecipe(
                        new GT_Shapeless_Recipe(
                            tinyDust,
                            new Object[] { entry.oreDictName, entry.oreDictName, entry.oreDictName, entry.oreDictName,
                ...
                if (!aMaterial.contains(SubTag.NO_SMELTING)
                    ...
                    if (aMaterial.mBlastFurnaceRequired) {
                        ...
                        GT_ModHandler.addInductionSmelterRecipe(
                            GT_Utility.copyAmount(9L, entry.ores.get(0)),
                            null,
                            ingot,
                            null,
                            130 * 3 * 2,
