            ...
            if (this.isExecutable(aPrefix, aMaterial)) {
                ...
                if (!aMaterial.contains(SubTag.NO_SMASHING)
                    ...
                    RecipeMaps.HAMMER.factory()
                        ...
                        .output(GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 1))
                        .buildAndRegister();
                    if (!GregTech_API.sBasicBending) {
                        RecipeMaps.BENDING.factory()
                            ...
                            .setShaped(true)
                            .input(RecipeEntry.fromStacks(1, entry.ores, Match.STRICT))
                    ...
                    if (GT_OreDictUnificator.get(OrePrefixes.plateDense, aMaterial) != null)
                        RecipeMaps.BENDING.factory()
                            .EUt(24)
                            .duration(Math.max(aMaterial.getMass() * 18, 1))
                            .setShaped(true)
                ...
                if (!OrePrefixes.block.isIgnored(aMaterial)) {
                    ...
                    GT_ModHandler
                        .addCompressionRecipe(entry, 9, GT_OreDictUnificator.get(OrePrefixes.block, aMaterial, 1L));
                ...
                if (GT_OreDictUnificator.get(OrePrefixes.stick, aMaterial) != null) {
                    RecipeHandler.executeOnFinish(
                        () -> GT_ModHandler.addCraftingRecipe(
                            ...
                            new Object[] { "F", "I", 'F', GT_ToolDictNames.craftingToolFile, 'I', entry.oreDictName }));
                ...
                if (null != (tStack = GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L))) {
                    ...
                    GT_RecipeRegistrator.registerUsagesForMaterials(
                        GT_Utility.copyAmount(1, entry.ores.get(0)), // TODO vanilla recipe replcer
                    ...
                    GT_RecipeRegistrator.registerUsagesForMaterials(
                        GT_Utility.copyAmount(1, entry.ores.get(0)),
                        GT_Utility.copyAmount(1, entry.ores.get(0)),
                        OrePrefixes.plate.get(aMaterial),
                        !aMaterial.contains(SubTag.NO_SMELTING),
                        false,
