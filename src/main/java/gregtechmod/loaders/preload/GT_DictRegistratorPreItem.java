...
public class GT_DictRegistratorPreItem implements Runnable {
    ...
    public void run() {
        ...
        GT_OreDictUnificator
            .add(OrePrefixes.cell, Materials.Creosote, GT_ModHandler.getRCItem("fluid.creosote.cell", 1));
        ...
        GT_OreDictUnificator
            .registerOre(OrePrefixes.gem, Materials.Diamond, GT_ModHandler.getIC2Item("industrialDiamond", 1));
        GT_OreDictUnificator.registerOre("craftingIndustrialDiamond", GT_ModHandler.getIC2Item("industrialDiamond", 1));

        GT_OreDictUnificator
            .registerOre("stoneObsidian", new ItemStack(Blocks.obsidian, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneMossy", new ItemStack(Blocks.mossy_cobblestone, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneCobble", new ItemStack(Blocks.mossy_cobblestone, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneCobble", new ItemStack(Blocks.cobblestone, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneSmooth", new ItemStack(Blocks.stone, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneBricks", new ItemStack(Blocks.stonebrick, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        ...
        GT_OreDictUnificator
            .registerOre("stoneSand", new ItemStack(Blocks.sandstone, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneNetherrack", new ItemStack(Blocks.netherrack, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneNetherBrick", new ItemStack(Blocks.nether_brick, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        GT_OreDictUnificator
            .registerOre("stoneEndstone", new ItemStack(Blocks.end_stone, 1, GregTech_API.ITEM_WILDCARD_DAMAGE));
        ...
        GT_OreDictUnificator
            .add(OrePrefixes.dust, Materials.HydratedCoal, GT_ModHandler.getIC2Item("hydratedCoalDust", 1));
        ...
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.Sapphire, new ItemStack(GregTech_API.sBlockList[0], 1, 5));
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.Aluminium, new ItemStack(GregTech_API.sBlockList[0], 1, 7));
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.Titanium, new ItemStack(GregTech_API.sBlockList[0], 1, 8));
        ...
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.Electrum, new ItemStack(GregTech_API.sBlockList[4], 1, 1));
        ...
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.GreenSapphire, new ItemStack(GregTech_API.sBlockList[4], 1, 4));
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.Cooperite, new ItemStack(GregTech_API.sBlockList[4], 1, 5));
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.Tungsten, new ItemStack(GregTech_API.sBlockList[4], 1, 6));
        ...
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.Iridium, new ItemStack(GregTech_API.sBlockList[4], 1, 12));
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.GarnetYellow, new ItemStack(GregTech_API.sBlockList[4], 1, 14));
        GT_OreDictUnificator
            .add(OrePrefixes.block, Materials.GarnetRed, new ItemStack(GregTech_API.sBlockList[4], 1, 15));
        ...
        // }
        //
        // //GT_OreDictUnificator.override("plateTin" , GT_ModHandler.getRCItem("part.plate.tin", 1)); needs 50% Iron
        // and 50% Tin to be crafted
