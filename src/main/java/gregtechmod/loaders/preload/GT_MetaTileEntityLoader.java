...
public class GT_MetaTileEntityLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Items.Machine_Bronze_CraftingTable
            .set(new GT_MetaTileEntity_BronzeCraftingTable(128, "GT_BronzeTable").getStackForm(1));
        GT_Items.Machine_Bronze_Boiler.set(new GT_MetaTileEntity_Boiler_Bronze(129, "GT_BronzeBoiler").getStackForm(1));
        GT_Items.Machine_Bronze_Macerator.set(
            new GT_MetaTileEntity_BronzeMacerator(130, "GT_BronzeMacerator", RecipeMaps.MACERATION).getStackForm(1));
        GT_Items.Machine_Bronze_Furnace
            .set(new GT_MetaTileEntity_BronzeFurnace(131, "GT_BronzeFurnace", RecipeMaps.MELTING).getStackForm(1));
        GT_Items.Machine_Bronze_AlloySmelter.set(
            new GT_MetaTileEntity_BronzeAlloySmelter(132, "GT_BronzeAlloySmelter", RecipeMaps.ALLOY_SMELTING)
                .getStackForm(1));
        GT_Items.Machine_Bronze_Hammer.set(
            new GT_MetaTileEntity_BronzeSteamHammer(133, "GT_BronzeSteamHammer", RecipeMaps.HAMMER).getStackForm(1));
        GT_Items.Machine_Bronze_Compressor.set(
            new GT_MetaTileEntity_BronzeCompressor(134, "GT_BronzeCompressor", RecipeMaps.COMPRESSION).getStackForm(1));
        GT_Items.Machine_Bronze_Extractor.set(
            new GT_MetaTileEntity_BronzeExtractor(135, "GT_BronzeExtractor", RecipeMaps.EXTRACTION).getStackForm(1));
        GT_Items.Machine_Bronze_BlastFurnace
            .set(new GT_MetaTileEntity_BronzeBlastFurnace(136, "GT_BronzeBlastFurnace").getStackForm(1));
        GT_Items.Machine_Steel_Boiler.set(new GT_MetaTileEntity_Boiler_Steel(137, "GT_SteelBoiler").getStackForm(1));
        GT_Items.Machine_Steel_Furnace
            .set(new GT_MetaTileEntity_SteelFurnace(138, "GT_SteelFurnace", RecipeMaps.MELTING).getStackForm(1));
        ...
        GT_Items.Frame_StainlessSteel
            .set(new GT_MetaPipeEntity_Frame_StainlessSteel(1753, "GT_Frame_StainlessSteel").getStackForm(1));
        GT_Items.Frame_TungstenSteel
            .set(new GT_MetaPipeEntity_Frame_TungstenSteel(1754, "GT_Frame_TungstenSteel").getStackForm(1));

        GT_Items.Pipe_Bronze_Medium.set(new GT_MetaPipeEntity_Bronze(1800, "GT_Pipe_Bronze").getStackForm(1))
            .registerOre(OrePrefixes.pipeMedium.get(Materials.Bronze));
        GT_Items.Pipe_Steel_Medium.set(new GT_MetaPipeEntity_Steel(1801, "GT_Pipe_Steel").getStackForm(1))
            .registerOre(OrePrefixes.pipeMedium.get(Materials.Steel));
        GT_Items.Pipe_StainlessSteel_Medium
            .set(new GT_MetaPipeEntity_StainlessSteel(1802, "GT_Pipe_StainlessSteel").getStackForm(1))
            .registerOre(OrePrefixes.pipeMedium.get(Materials.StainlessSteel));
        GT_Items.Pipe_TungstenSteel_Medium
            .set(new GT_MetaPipeEntity_TungstenSteel(1803, "GT_Pipe_TungstenSteel").getStackForm(1))
            .registerOre(OrePrefixes.pipeMedium.get(Materials.TungstenSteel));

        GT_Items.Pipe_Bronze_Small.set(new GT_MetaPipeEntity_Bronze_Small(1825, "GT_Pipe_Bronze_Small").getStackForm(1))
            .registerOre(OrePrefixes.pipeSmall.get(Materials.Bronze));
        GT_Items.Pipe_Steel_Small.set(new GT_MetaPipeEntity_Steel_Small(1826, "GT_Pipe_Steel_Small").getStackForm(1))
            .registerOre(OrePrefixes.pipeSmall.get(Materials.Steel));
        GT_Items.Pipe_StainlessSteel_Small
            .set(new GT_MetaPipeEntity_StainlessSteel_Small(1827, "GT_Pipe_StainlessSteel_Small").getStackForm(1))
            .registerOre(OrePrefixes.pipeSmall.get(Materials.StainlessSteel));
        GT_Items.Pipe_TungstenSteel_Small
            .set(new GT_MetaPipeEntity_TungstenSteel_Small(1828, "GT_Pipe_TungstenSteel_Small").getStackForm(1))
            .registerOre(OrePrefixes.pipeSmall.get(Materials.TungstenSteel));

        GT_Items.Pipe_Bronze_Large.set(new GT_MetaPipeEntity_Bronze_Large(1850, "GT_Pipe_Bronze_Large").getStackForm(1))
            .registerOre(OrePrefixes.pipeLarge.get(Materials.Bronze));
        GT_Items.Pipe_Steel_Large.set(new GT_MetaPipeEntity_Steel_Large(1851, "GT_Pipe_Steel_Large").getStackForm(1))
            .registerOre(OrePrefixes.pipeLarge.get(Materials.Steel));
        GT_Items.Pipe_StainlessSteel_Large
            .set(new GT_MetaPipeEntity_StainlessSteel_Large(1852, "GT_Pipe_StainlessSteel_Large").getStackForm(1))
            .registerOre(OrePrefixes.pipeLarge.get(Materials.StainlessSteel));
        GT_Items.Pipe_TungstenSteel_Large
            .set(new GT_MetaPipeEntity_TungstenSteel_Large(1853, "GT_Pipe_TungstenSteel_Large").getStackForm(1))
            .registerOre(OrePrefixes.pipeLarge.get(Materials.TungstenSteel));

        GT_Items.Pipe_Brass_Medium.set(new GT_MetaPipeEntity_Brass(1900, "GT_Pipe_Brass").getStackForm(1))
            .registerOre(OrePrefixes.pipeMedium.get(Materials.Brass));
        GT_Items.Pipe_Electrum_Medium.set(new GT_MetaPipeEntity_Electrum(1901, "GT_Pipe_Electrum").getStackForm(1))
            .registerOre(OrePrefixes.pipeMedium.get(Materials.Electrum));
        GT_Items.Pipe_Cooperite_Medium.set(new GT_MetaPipeEntity_Cooperite(1902, "GT_Pipe_Cooperite").getStackForm(1))
            .registerOre(OrePrefixes.pipeMedium.get(Materials.Cooperite));

        GT_Items.Pipe_Brass_Large.set(new GT_MetaPipeEntity_Brass_Large(1950, "GT_Pipe_Brass_Large").getStackForm(1))
            .registerOre(OrePrefixes.pipeLarge.get(Materials.Brass));
        GT_Items.Pipe_Electrum_Large
            .set(new GT_MetaPipeEntity_Electrum_Large(1951, "GT_Pipe_Electrum_Large").getStackForm(1))
            .registerOre(OrePrefixes.pipeLarge.get(Materials.Electrum));
        GT_Items.Pipe_Cooperite_Large
            .set(new GT_MetaPipeEntity_Cooperite_Large(1952, "GT_Pipe_Cooperite_Large").getStackForm(1))
            .registerOre(OrePrefixes.pipeLarge.get(Materials.Cooperite));
    }
}
