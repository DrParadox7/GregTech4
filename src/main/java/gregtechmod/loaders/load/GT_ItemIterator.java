...
public class GT_ItemIterator implements Runnable {
    ...
    public void run() {
        ...
        GT_Log.log
            .info("Adding Food Recipes to the Automatic Canning Machine. (also during the following Item Iteration)");
        RecipeMaps.CANNING.factory()
            .EUt(1)
            .duration(100)
            .inputs(
                new ItemStack(Items.rotten_flesh, 1, GregTech_API.ITEM_WILDCARD_DAMAGE),
                GT_Items.IC2_Food_Can_Empty.get(2L))
            .output(GT_Items.IC2_Food_Can_Spoiled.get(2))
            .buildAndRegister();
        RecipeMaps.CANNING.factory()
            .EUt(1)
            .duration(100)
            .inputs(
                new ItemStack(Items.spider_eye, 1, GregTech_API.ITEM_WILDCARD_DAMAGE),
                GT_Items.IC2_Food_Can_Empty.get(1L))
            .output(GT_Items.IC2_Food_Can_Spoiled.get(1))
            .buildAndRegister();
        RecipeMaps.CANNING.factory()
            .EUt(1)
            .duration(100)
            .inputs(
                new ItemStack(Items.poisonous_potato, 1, GregTech_API.ITEM_WILDCARD_DAMAGE),
                GT_Items.IC2_Food_Can_Empty.get(1L))
            .output(GT_Items.IC2_Food_Can_Spoiled.get(1))
            .buildAndRegister();
        RecipeMaps.CANNING.factory()
            ...
            .duration(600)
            .inputs(
                new ItemStack(Items.cake, 1, GregTech_API.ITEM_WILDCARD_DAMAGE),
                GT_Items.IC2_Food_Can_Empty.get(6L))
            .output(GT_Items.IC2_Food_Can_Filled.get(6))
            .buildAndRegister();
        RecipeMaps.CANNING.factory()
            .EUt(1)
            .duration(300)
            .inputs(
                new ItemStack(Items.mushroom_stew, 1, GregTech_API.ITEM_WILDCARD_DAMAGE),
                GT_Items.IC2_Food_Can_Empty.get(3L))
            .output(GT_Items.IC2_Food_Can_Filled.get(3))
            .output(new ItemStack(Items.bowl, 1))
            .buildAndRegister();

        if (GT_Mod.AE2_loaded) {
            Optional<ItemStack> opt = appeng.api.AEApi.instance()
                .definitions()
                .blocks()
                .quartz()
                .maybeStack(1);
            if (opt.isPresent()) GT_OreDictUnificator.add(OrePrefixes.block, Materials.CertusQuartz, opt.get());
        }
            ...
            if (tItem != null && (tName = tItem.getUnlocalizedName()) != null) {
                    ...
                    if (tItem instanceof mods.railcraft.api.core.items.IToolCrowbar) {
                        if (!tItem.isDamageable() && !GT_ModHandler.isElectricItem(new ItemStack(tItem, 1, 0))) {
                            if (GregTech_API.sRecipeFile
                                .get(GT_ConfigCategories.Recipes.disabledrecipes, "infiniteDurabilityRCCrowbars", false)
                                && GT_ModHandler
                                    .removeRecipeByOutput(new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE))) {
                                GT_Log.log.info("Removed infinite RC Crowbar: " + tName);
                            }
                        } else if (GregTech_API
                            .registerCrowbar(new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE))) {
                ...
                try {
                    if (tItem instanceof cofh.api.item.IToolHammer) {
                        if (!tItem.isDamageable() && !GT_ModHandler.isElectricItem(new ItemStack(tItem, 1, 0))) {
                            if (GregTech_API.sRecipeFile
                                .get(GT_ConfigCategories.Recipes.disabledrecipes, "infiniteDurabilityMFRHammers", false)
                                && GT_ModHandler
                                    .removeRecipeByOutput(new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE))) {
                ...
                try {
                    if (tItem instanceof buildcraft.api.tools.IToolWrench
                        && !(tItem instanceof mods.railcraft.api.core.items.IToolCrowbar)) {
                        if (!tItem.isDamageable() && !GT_ModHandler.isElectricItem(new ItemStack(tItem, 1, 0))) {
                            if (GregTech_API.sRecipeFile
                                .get(GT_ConfigCategories.Recipes.disabledrecipes, "infiniteDurabilityBCWrenches", false)
                                && GT_ModHandler
                                    .removeRecipeByOutput(new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE))) {
                                GT_Log.log.info("Removed infinite BC Wrench: " + tName);
                            }
                        } else if (GregTech_API
                            .registerWrench(new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE))) {
                ...
                if (tItem instanceof ItemBlock) {
                    try {
                        ...
                        if (tBlock != null && GT_Mod.sBlockStackSize < tItem.getItemStackLimit()) {
                            try {
                                if (tBlock.isReplaceableOreGen(GregTech_API.sDummyWorld, 0, 0, 0, Blocks.stone)
                                    ...
                                    || tBlock
                                        .isReplaceableOreGen(GregTech_API.sDummyWorld, 0, 0, 0, Blocks.end_stone)) {
                        ...
                        GT_Log.log.error(
                            "ERROR! A Mod attempted to return an invalid Block ID using ItemBlock! Please mention this to the respective Mod Author, who owns the following Item.");
                        GT_Log.log
                            .error("ITEM: " + tItem + " - " + tItem.getItemStackDisplayName(new ItemStack(tItem)));
                ...
                if (tItem instanceof ItemFood && tItem != GT_Items.IC2_Food_Can_Filled.getItem()
                    && tItem != GT_Items.IC2_Food_Can_Spoiled.getItem()) {
                    final int tFoodValue = (int) Math
                        .ceil(((ItemFood) tItem).func_150905_g(new ItemStack(tItem)) / 2.0D);
                    if (tFoodValue > 0) {
                        RecipeFactory<?> fac = RecipeMaps.CANNING.factory()
                            .EUt(1)
                            .duration(tFoodValue * 100)
                            .inputs(
                                new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE),
                                GT_Items.IC2_Food_Can_Empty.get(tFoodValue))
                            .output(GT_Items.IC2_Food_Can_Filled.get(tFoodValue));
                ...
                switch (tName) {
                    ...
                    case "item.ItemSensorLocationCard":
                        RecipeMaps.ASSEMBLING.factory()
                            .EUt(32)
                            .duration(200)
                            .input(new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE))
                            .output(GT_Items.Circuit_Basic.get(2))
                            .buildAndRegister();
                        break;
                    case "item.ItemTimeCard":
                        RecipeMaps.ASSEMBLING.factory()
                            ...
                            .duration(100)
                            .input(new ItemStack(tItem, 1, GregTech_API.ITEM_WILDCARD_DAMAGE))
                            .output(GT_Items.Circuit_Basic.get(1))
                            .buildAndRegister();
                        break;
                    case "tile.beehives":
                        if (Block.getBlockFromItem(tItem) != null) {
                            ((GT_Tool_Item) GT_Items.Tool_Scoop_Aluminium.getItem()).addToMaterialList(
                                Block.getBlockFromItem(tItem)
                                    .getMaterial());
                        }
                        break;
                    ...
                    case "item.venisonCooked":
                        RecipeMaps.CENTRIFUGE.factory()
                            ...
                            .duration(5000)
                            .setShaped(true)
                            .inputs(GT_Items.Cell_Empty.get(1), new ItemStack(tItem, 16, 0))
                    ...
                    case "item.venisonRaw":
                        RecipeMaps.CENTRIFUGE.factory()
                            ...
                            .duration(5000)
                            .setShaped(true)
                            .inputs(GT_Items.Cell_Empty.get(1), new ItemStack(tItem, 12, 0))
                            .output(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Methane, 1L))
                            .buildAndRegister();
                        break;
                    ...
                    case "tile.TFRoots":
                        ...
                        RecipeMaps.SAWMILL.factory()
                            ...
                            .duration(200)
                            .setShaped(true)
                            .input(new ItemStack(tItem, 1, 0))
                            .input(GT_ModHandler.getWater(1000))
                            .outputs(new ItemStack(Items.stick, 2))
                            .chanced(new ItemStack(Items.stick, 1), 7500)
                            .chanced(new ItemStack(Items.stick, 1), 2500)
                            .buildAndRegister();
                        RecipeMaps.MAGIC_FUELS.factory()
                            .EUt(16)
                            .duration(2)
                            .input(new ItemStack(tItem, 1, 1))
                    ...
                    case "item.liveRoot":
                        RecipeMaps.MAGIC_FUELS.factory()
                            ...
                            .duration(1)
                            .input(new ItemStack(tItem, 1, 0))
                            .output(new ItemStack(Items.stick, 2))
                            .buildAndRegister();
                    ...
                    case "item.ItemEssence":
                        RecipeMaps.MAGIC_FUELS.factory()
                            .EUt(20)
                            .duration(8)
                            .input(RecipeEntry.singleton(new ItemStack(tItem, 1, 1), Match.DAMAGE))
                            .output(new ItemStack(tItem, 1, 0))
                            .buildAndRegister();
                        break;
                    ...
                    case "item.ItemResource":
                        ...
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.gem, Materials.Mercury, new ItemStack(tItem, 1, 3));
                        break;
                    ...
                    case "tile.railcraft.brick.quarried":
                        ...
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Marble, new ItemStack(tItem, 1, 1));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Marble, new ItemStack(tItem, 1, 2));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Marble, new ItemStack(tItem, 1, 3));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Marble, new ItemStack(tItem, 1, 4));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Marble, new ItemStack(tItem, 1, 5));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Marble, new ItemStack(tItem, 1, 6));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Marble, new ItemStack(tItem, 1, 7));
                        break;
                    case "tile.railcraft.brick.abyssal":
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Basalt, new ItemStack(tItem, 1, 0));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Basalt, new ItemStack(tItem, 1, 1));
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Basalt, new ItemStack(tItem, 1, 2));
                        GT_OreDictUnificator
                        ...
                        GT_OreDictUnificator
                            .registerOre(OrePrefixes.stone, Materials.Basalt, new ItemStack(tItem, 1, 7));
                        break;
                    ...
                    case "item.bucketFuel":
                        GT_ModHandler.addCraftingRecipe(
                            GT_ModHandler.getRecipeOutput(
                                ...
                                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L),
                                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L),
                                new ItemStack(tItem, 1),
                                GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 1L)),
                            new Object[] { " S ", "SCS", "SLS", 'S', OrePrefixes.plate.get(Materials.Steel), 'C',
                                OrePrefixes.circuit.get(Materials.Basic), 'L',
                                OrePrefixes.cell.get(Materials.Lithium) });
                        break;
                    case "item.canLava":
