...
public class GT_CoverBehaviorLoader implements Runnable {
    ...
    public void run() {
        ...
        new GT_Cover_Vent(
            new ItemStack[] { GT_ModHandler.getIC2Item("reactorVent", 1),
                GT_ModHandler.getIC2Item("reactorVentCore", 1), GT_ModHandler.getIC2Item("reactorVentSpread", 1) },
            1);
        new GT_Cover_Vent(
            new ItemStack[] { GT_ModHandler.getIC2Item("reactorVentDiamond", 1),
                GT_ModHandler.getIC2Item("reactorVentGold", 1) },
            2);
