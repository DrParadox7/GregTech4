...
public class DistillationRecipeHandler extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            transferRects
                .add(new RecipeTransferRect(new Rectangle(80 - sOffsetX, 4 - sOffsetY, 16, 72), getRecipeId()));

            ArrayList<Class<? extends GuiContainer>> guis = new ArrayList<Class<? extends GuiContainer>>();
            ArrayList<RecipeTransferRect> transferRects2 = new ArrayList<RecipeTransferRect>();
            guis.add(GT_GUIContainer_DistillationTower.class);
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(80 - 5, 4 - 11, 16, 72), getRecipeId(), new Object[0]));
