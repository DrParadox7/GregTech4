...
public class AlloySmelterRecipeHandler extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            transferRects
                .add(new RecipeTransferRect(new Rectangle(70 - sOffsetX, 24 - sOffsetY, 36, 18), getRecipeId()));

            ArrayList<Class<? extends GuiContainer>> guis = new ArrayList<Class<? extends GuiContainer>>();
            ArrayList<RecipeTransferRect> transferRects2 = new ArrayList<RecipeTransferRect>();
            guis.add(GT_GUIContainer_BasicMachine_AlloySmelter.class);
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(70 - 5, 24 - 11, 36, 18), getRecipeId(), new Object[0]));
            ...
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(70 - 5, 24 - 11, 36, 18), "smelting", new Object[0]));
            RecipeTransferRectHandler.registerRectsToGuis(guis, transferRects2);
            ...
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(70 - 5, 24 - 11, 36, 18), "ic2.macerator", new Object[0]));
            RecipeTransferRectHandler.registerRectsToGuis(guis, transferRects2);
            ...
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(70 - 5, 24 - 11, 36, 18), "ic2.extractor", new Object[0]));
            RecipeTransferRectHandler.registerRectsToGuis(guis, transferRects2);
            ...
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(70 - 5, 24 - 11, 36, 18), "ic2.compressor", new Object[0]));
            RecipeTransferRectHandler.registerRectsToGuis(guis, transferRects2);
            ...
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(61 - 5, 62 - 11, 18, 18), "ic2.scrapbox", new Object[0]));
            RecipeTransferRectHandler.registerRectsToGuis(guis, transferRects2);
        } catch (Throwable e) {
    ...
    public void drawExtras(int recipe) {
        ...
        drawText(
            30,
            80,
            I18n.format("nei.extras.eu_total", GT_Utility.parseNumberToString(rec.mDuration * rec.mEUt)),
            0xFF000000,
            false);
        drawText(
            30,
