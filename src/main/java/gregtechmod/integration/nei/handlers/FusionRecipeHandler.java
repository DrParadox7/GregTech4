...
public class FusionRecipeHandler extends GT_RecipeHandler {
    ...
    public void loadTransferRects() {
        try {
            transferRects
                .add(new RecipeTransferRect(new Rectangle(47 - sOffsetX, 34 - sOffsetY, 50, 18), getRecipeId()));

            ArrayList<Class<? extends GuiContainer>> guis = new ArrayList<Class<? extends GuiContainer>>();
            ArrayList<RecipeTransferRect> transferRects2 = new ArrayList<RecipeTransferRect>();
            guis.add(GT_GUIContainer_FusionComputer.class);
            transferRects2
                .add(new RecipeTransferRect(new Rectangle(154 - 5, 4 - 11, 18, 18), getRecipeId(), new Object[0]));
    ...
    public void drawExtras(int recipe) {
        ...
        drawText(
            30,
            80,
            I18n.format("nei.fusion_reactor.info.1", GT_Utility.parseNumberToString(t.mStartEU)),
            0xFF000000,
            false);
        ...
        drawText(
            30,
            100,
            I18n.format("nei.extras.time", GT_Utility.parseNumberToString(t.mDuration * 1.0D / 20.0D)),
            0xFF000000,
            false);
        if (t.mEUt < 0) drawText(
            30,
            110,
            I18n.format("nei.fusion_reactor.info.2", GT_Utility.parseNumberToString(-t.mEUt * t.mDuration)),
            0xFF000000,
            false);
        else drawText(
            30,
