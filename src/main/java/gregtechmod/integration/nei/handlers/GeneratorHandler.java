...
public class GeneratorHandler extends GT_RecipeHandler {
    ...
    public GeneratorHandler(RecipeMap<?> recipeMap, String machineName,
        List<Class<? extends GuiContainer>> containers) {
        ...
        try {
            transferRects
                .add(new RecipeTransferRect(new Rectangle(96 - sOffsetX, 36 - sOffsetY, 18, 18), getRecipeId()));
            ArrayList<Class<? extends GuiContainer>> guis = new ArrayList<Class<? extends GuiContainer>>();
            ArrayList<RecipeTransferRect> transferRects2 = new ArrayList<RecipeTransferRect>();
            guis.addAll(overlays);
            transferRects2.add(
                new RecipeTransferRect(
                    new Rectangle(76 - sOffsetX, 39 - sOffsetY, 18, 18),
                    getRecipeId(),
                    new Object[0]));
