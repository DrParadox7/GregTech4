...
public class WiremillRecipeHandler extends GT_RecipeHandler {
    ...
    public void drawExtras(int recipeIdx) {
        ...
        drawText(
            30,
            80,
            I18n.format("nei.extras.eu_total", GT_Utility.parseNumberToString(recipe.mDuration * recipe.mEUt)),
            0xFF000000,
            false);
        drawText(
            30,
            90,
            I18n.format("nei.extras.time", GT_Utility.parseNumberToString(recipe.mDuration * 1.0D / 20.0D)),
            0xFF000000,
            false);
        drawText(
            30,
            100,
            I18n.format("nei.extras.eut", GT_Utility.parseNumberToString(recipe.mEUt)),
            0xFF000000,
            false);
    }
}
