    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (mContainer != null) {
            ...
            fontRenderer.drawString(
                I18n.format("metatileentity.GT_IDSU.UI.ID", GT_Utility.parseNumberToString(idsu.mPlayerHash.get())),
                11,
                17,
                16448255);
            fontRenderer.drawString(
                I18n.format("metatileentity.STORAGE_EU", GT_Utility.parseNumberToString(idsu.mEnergy.get())),
                11,
                26,
                16448255);
            fontRenderer.drawString(
                I18n.format("metatileentity.STORAGE_EU_MAX", GT_Utility.parseNumberToString(idsu.mStorage.get())),
                11,
                35,
                16448255);
            fontRenderer.drawString(
