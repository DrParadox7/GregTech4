...
public class GT_GUIContainer_RedstoneCircuitBlock extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_RedstoneCircuitBlock(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
        super(
            ...
            GregTech_API.GUI_PATH + "RedstoneCircuitBlock.png");
    }

    @Override
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        GT_CircuitryBehavior tCircuit = GregTech_API.sCircuitryBehaviors
            .get(((GT_Container_RedstoneCircuitBlock) mContainer).mGate.get());
        if (tCircuit != null) {
            fontRenderer.drawString(tCircuit.getName(), 46, 8, 16448255);
            fontRenderer.drawString(tCircuit.getDescription(), 46, 19, 16448255);

            fontRenderer.drawString(
                tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get(), 0),
                46,
                33,
                16448255);
            fontRenderer.drawString(
                tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get(), 1),
                46,
                44,
                16448255);
            fontRenderer.drawString(
                tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get(), 2),
                46,
                55,
                16448255);
            fontRenderer.drawString(
                tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get(), 3),
                46,
                66,
                16448255);
            ...
            fontRenderer
                .drawString(
                    tString == null
                        ? GT_Utility
                            .parseNumberToString(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get()[0])
                        : tString,
                    99,
                    33,
                    16448255);
            ...
            fontRenderer
                .drawString(
                    tString == null
                        ? GT_Utility
                            .parseNumberToString(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get()[1])
                        : tString,
                    99,
                    44,
                    16448255);
            ...
            fontRenderer
                .drawString(
                    tString == null
                        ? GT_Utility
                            .parseNumberToString(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get()[2])
                        : tString,
                    99,
                    55,
                    16448255);
            ...
            fontRenderer
                .drawString(
                    tString == null
                        ? GT_Utility
                            .parseNumberToString(((GT_Container_RedstoneCircuitBlock) mContainer).mData.get()[3])
                        : tString,
                    99,
                    66,
                    16448255);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (mContainer != null) {
            ...
            if (m.mDisplayErrorCode.get() > 0)
                if ((m.mTileEntity.getTimer() / 5) % 2 == 0) drawTexturedModalRect(x + 140, y + 9, 194, 0, 7, 7);
                else;
