...
public class GT_GUIContainer_TradeOMat_Settings extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_TradeOMat_Settings(final InventoryPlayer aInventoryPlayer,
        final IGregTechTileEntity aTileEntity) {
        super(
            new GT_Container_TradeOMat_Settings(aInventoryPlayer, aTileEntity),
            "gregtech_addon:textures/gui/Tradeomat_Settings.png");
    }
    ...
    protected void drawGuiContainerForegroundLayer(final int par1, final int par2) {
        ...
        if (this.mContainer != null) {
            this.fontRenderer.drawString(
                "Performed Trades: " + GT_Utility
                    .parseNumberToString(((GT_Container_TradeOMat_Settings) this.mContainer).mPerformedTrades.get()),
                8,
                64,
                4210752);
        }
