...
public class GT_GUIContainer_ElectricTypeSorter extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_ElectricTypeSorter(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
        super(
            new GT_Container_ElectricTypeSorter(aInventoryPlayer, aTileEntity),
            GregTech_API.GUI_PATH + "ElectricTypeSorter.png");
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (mContainer != null) {
            drawTexturedModalRect(
                x + 70,
                y + 22,
                ((GT_Container_ElectricTypeSorter) mContainer).mMode.get() * 18,
                166,
                18,
                18);
        }
