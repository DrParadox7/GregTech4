...
public class GT_GUIContainer_Destructopack extends GT_GUIContainer {
    ...
    public GT_GUIContainer_Destructopack(InventoryPlayer aInventoryPlayer, ItemStack aItem) {
        super(
            new GT_Container_Item_Destructopack(aInventoryPlayer, aItem),
            GregTech_API.GUI_PATH + "Destructopack.png");
    }
    ...
    protected void drawTooltips(int posX, int posY) {
        ...
        if (theSlot != null) {
            try {
                ...
                if (stack != null && theSlot.get(this) instanceof GT_Slot_Holo
                    && (FluidContainerRegistry.isContainer(stack) || stack.getItem() instanceof IFluidContainerItem)) {
                    this.func_146283_a(
                        Collections.singletonList(I18n.format("item.destructpack.fluid_info")),
                        posX,
                        posY);
                }
            } catch (Throwable e) {}
