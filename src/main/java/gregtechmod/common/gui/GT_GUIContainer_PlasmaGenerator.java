...
public class GT_GUIContainer_PlasmaGenerator extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRenderer.drawString(I18n.format("metatileentity.GT_PlasmaGenerator.name"), 8, 6, 4210752);
        if (mContainer != null) {
            fontRenderer.drawString(I18n.format("metatileentity.GT_PlasmaGenerator.amount"), 10, 20, 16448255);
            fontRenderer.drawString(
                GT_Utility.parseNumberToString(((GT_Container_BasicTank) mContainer).mContent.get()),
                10,
                30,
                16448255);
        }
