...
public class GT_GUIContainer_TradeOMat_Inventory_Objects extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_TradeOMat_Inventory_Objects(final InventoryPlayer aInventoryPlayer,
        final IGregTechTileEntity aTileEntity) {
        super(
            new GT_Container_TradeOMat_Inventory_Objects(aInventoryPlayer, aTileEntity),
            "gregtech_addon:textures/gui/Tradeomat_Inventory.png");
    }
