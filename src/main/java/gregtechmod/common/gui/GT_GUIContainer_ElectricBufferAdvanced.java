...
public class GT_GUIContainer_ElectricBufferAdvanced extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_ElectricBufferAdvanced(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
        super(
            new GT_Container_ElectricBufferAdvanced(aInventoryPlayer, aTileEntity),
            GregTech_API.GUI_PATH + "ElectricBufferAdvanced.png");
    }

    @Override
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        fontRenderer
            .drawString("" + ((GT_Container_ElectricBufferAdvanced) mContainer).mTargetSlot.get(), 100, 65, 16448255);
    }
