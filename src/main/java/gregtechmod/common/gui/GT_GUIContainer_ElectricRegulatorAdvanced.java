...
public class GT_GUIContainer_ElectricRegulatorAdvanced extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_ElectricRegulatorAdvanced(InventoryPlayer aInventoryPlayer,
        IGregTechTileEntity aTileEntity) {
        super(
            new GT_Container_ElectricRegulatorAdvanced(aInventoryPlayer, aTileEntity),
            GregTech_API.GUI_PATH + "ElectricRegulatorAdvanced.png");
    }
