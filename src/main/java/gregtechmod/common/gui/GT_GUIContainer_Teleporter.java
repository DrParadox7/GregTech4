...
public class GT_GUIContainer_Teleporter extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRenderer.drawString(I18n.format("metatileentity.GT_Teleporter.name"), 46, 8, 16448255);
        if (mContainer != null) {
            fontRenderer.drawString(
                "X: " + GT_Utility.parseNumberToString(((GT_Container_Teleporter) mContainer).mTargetX.get()),
                46,
                16,
                16448255);
            fontRenderer.drawString(
                "Y: " + GT_Utility.parseNumberToString(((GT_Container_Teleporter) mContainer).mTargetY.get()),
                46,
                24,
                16448255);
            fontRenderer.drawString(
                "Z: " + GT_Utility.parseNumberToString(((GT_Container_Teleporter) mContainer).mTargetZ.get()),
                46,
                32,
                16448255);
