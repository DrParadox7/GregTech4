...
public class GT_GUIContainer_ElectricFilter extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_ElectricFilter(final InventoryPlayer aInventoryPlayer,
        final IGregTechTileEntity aTileEntity) {
        super(
            new GT_Container_ElectricFilter(aInventoryPlayer, aTileEntity),
            "gregtech_addon:textures/gui/ElectricFilter.png");
    }
