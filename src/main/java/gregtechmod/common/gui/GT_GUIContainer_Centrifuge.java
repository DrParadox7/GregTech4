...
public class GT_GUIContainer_Centrifuge extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if ((((GT_Container_Centrifuge) mContainer).mDisplayErrorCode.get() & 1) != 0) fontRenderer.drawSplitString(
            StatCollector.translateToLocal("metatileentity.NOT_ENOUGH_ENERGY"),
            8,
            ySize - 102,
            90,
            4210752);
