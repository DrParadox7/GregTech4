...
public class UnifierRecipeEntry implements Ingredient, IRecipeInput {
    ...
    public UnifierRecipeEntry(OrePrefixes prefix, Materials material, int count) {
        ...
        if (!OreDictionary.doesOreNameExist(prefix.get(material))) throw new IllegalArgumentException(
            "OrePrefix & Materials combination returns null item! " + prefix.get(material));
        this.prefix = prefix;
    ...
    public String toString() {
        ...
        return new ToStringBuilder(this).append("prefix", prefix)
