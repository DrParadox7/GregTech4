...
public class GT_BlockMetaID_Block extends Block {
    ...
    public static IIcon[] mIcons = new IIcon[52], mIconGasTurbine = new IIcon[9], mIconGasTurbineActive = new IIcon[9],
        mIconSteamTurbine = new IIcon[9], mIconSteamTurbineActive = new IIcon[9], mIconPlasmaTurbine = new IIcon[9],
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        for (int i = 0; i < mIcons.length; i++)
            mIcons[i] = par1IconRegister.registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + getUnlocalizedName() + "/" + i);
        for (int i = 0; i < mIconGasTurbine.length; i++) mIconGasTurbine[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.GasTurbine/GasTurbine" + (i + 1));
        for (int i = 0; i < mIconGasTurbineActive.length; i++) mIconGasTurbineActive[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.GasTurbine/GasTurbineActive" + (i + 1));
        for (int i = 0; i < mIconSteamTurbine.length; i++) mIconSteamTurbine[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.SteamTurbine/SteamTurbine" + (i + 1));
        for (int i = 0; i < mIconSteamTurbineActive.length; i++) mIconSteamTurbineActive[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.SteamTurbine/SteamTurbineActive" + (i + 1));
        for (int i = 0; i < mIconPlasmaTurbine.length; i++) mIconPlasmaTurbine[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.PlasmaTurbine/PlasmaTurbine" + (i + 1));
        for (int i = 0; i < mIconPlasmaTurbineActive.length; i++) mIconPlasmaTurbineActive[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.PlasmaTurbine/PlasmaTurbineActive" + (i + 1));
        this.blockIcon = mIcons[0];
    ...
    public IIcon getIcon(IBlockAccess aWorld, int xCoord, int yCoord, int zCoord, int aSide) {
        ...
        if (tMeta < 13 || (xCoord == 0 && yCoord == 0 && zCoord == 0) || !mConnectedMachineTextures)
            return this.getIcon(aSide, tMeta);
        ...
        if (tMeta == 13) {
            ...
            if (aSide == 2 || aSide == 3) {
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord - 1, zCoord))
                    ...
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[0];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[3];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord + 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[6];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord, yCoord - 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[1];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord, yCoord + 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[7];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord + 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[8];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[5];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord - 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_SteamTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconSteamTurbineActive[2];
        ...
        if (tMeta == 14) {
            ...
            if (aSide == 2 || aSide == 3) {
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord - 1, zCoord))
                    ...
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[0];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[3];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord + 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[6];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord, yCoord - 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[1];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord, yCoord + 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[7];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord + 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[8];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[5];
                ...
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord - 1, zCoord))
                    ...
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof GT_MetaTileEntity_Multi_GasTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconGasTurbineActive[2];
        ...
        if (tMeta == 15) {
            ...
            if (aSide == 2 || aSide == 3) {
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord - 1, zCoord))
                    ...
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[0];
                    return mIconPlasmaTurbine[0];
                }
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord, zCoord))
                    && tTileEntity instanceof IGregTechTileEntity
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[3];
                    return mIconPlasmaTurbine[3];
                }
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 3 ? +1 : -1), yCoord + 1, zCoord))
                    && tTileEntity instanceof IGregTechTileEntity
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[6];
                    return mIconPlasmaTurbine[6];
                }
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord, yCoord - 1, zCoord))
                    && tTileEntity instanceof IGregTechTileEntity
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[1];
                    return mIconPlasmaTurbine[1];
                }
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord, yCoord + 1, zCoord))
                    && tTileEntity instanceof IGregTechTileEntity
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[7];
                    return mIconPlasmaTurbine[7];
                }
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord + 1, zCoord))
                    && tTileEntity instanceof IGregTechTileEntity
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[8];
                    return mIconPlasmaTurbine[8];
                }
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord, zCoord))
                    && tTileEntity instanceof IGregTechTileEntity
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[5];
                    return mIconPlasmaTurbine[5];
                }
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord + (aSide == 2 ? +1 : -1), yCoord - 1, zCoord))
                    && tTileEntity instanceof IGregTechTileEntity
                    && ((IGregTechTileEntity) tTileEntity).getFrontFacing() == aSide
                    && null != (tMetaTileEntity = ((IGregTechTileEntity) tTileEntity).getMetaTileEntity())
                    && tMetaTileEntity instanceof MultiPlasmaTurbine) {
                    if (((IGregTechTileEntity) tTileEntity).isActive()) return mIconPlasmaTurbineActive[2];
                    return mIconPlasmaTurbine[2];
                }
            } else if (aSide == 4 || aSide == 5) {
                if (null != (tTileEntity = aWorld.getTileEntity(xCoord, yCoord - 1, zCoord + (aSide == 4 ? +1 : -1)))
                    && tTileEntity instanceof IGregTechTileEntity
