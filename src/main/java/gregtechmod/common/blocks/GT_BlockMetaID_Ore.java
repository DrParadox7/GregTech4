...
public class GT_BlockMetaID_Ore extends Block {
    ...
    public IIcon[] mIconsRed = new IIcon[96], mIconsBlack = new IIcon[96], mIconsStone = new IIcon[96],
        mIconsNether = new IIcon[96], mIconsEnd = new IIcon[96], mIcons = new IIcon[96];
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        for (int i = 0; i < 96; i++)
            mIcons[i] = par1IconRegister.registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.Ore_Default" + "/" + i);
        for (int i = 0; i < 96; i++) mIconsStone[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.Ore_Stone" + "/" + i);
        for (int i = 0; i < 96; i++) mIconsNether[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.Ore_Nether" + "/" + i);
        for (int i = 0; i < 96; i++)
            mIconsEnd[i] = par1IconRegister.registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.Ore_End" + "/" + i);
        for (int i = 0; i < 96; i++) mIconsBlack[i] = par1IconRegister
            .registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.Ore_Black" + "/" + i);
        for (int i = 0; i < 96; i++)
            mIconsRed[i] = par1IconRegister.registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + "tile.Ore_Red" + "/" + i);
    }
    ...
    public ArrayList<ItemStack> getDrops(World aWorld, int aX, int aY, int aZ, int aMeta, int aFortune) {
        ...
        switch (aMeta) {
            case 2:
                rList.add(
                    GT_OreDictUnificator
                        .get(OrePrefixes.gem, Materials.Iridium, 1 + aWorld.rand.nextInt(1 + (aFortune / 2))));
                break;
            case 3:
                rList.add(
                    GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Ruby, 1 + aWorld.rand.nextInt(1 + aFortune)));
            ...
            case 4:
                rList.add(
                    GT_OreDictUnificator
                        .get(OrePrefixes.gem, Materials.Sapphire, 1 + aWorld.rand.nextInt(1 + aFortune)));
            ...
            case 6:
                rList.add(
                    GT_OreDictUnificator
                        .get(OrePrefixes.dust, Materials.Pyrite, 2 + aWorld.rand.nextInt(1 + aFortune)));
                break;
            case 7:
                rList.add(
                    GT_OreDictUnificator
                        .get(OrePrefixes.dust, Materials.Cinnabar, 2 + aWorld.rand.nextInt(1 + aFortune)));
            ...
            case 8:
                rList.add(
                    GT_OreDictUnificator
                        .get(OrePrefixes.dust, Materials.Sphalerite, 2 + aWorld.rand.nextInt(1 + aFortune)));
                if (aWorld.rand.nextInt(Math.max(1, 4 / (aFortune + 1))) == 0)
            ...
            case 11:
                rList.add(
                    GT_OreDictUnificator
                        .get(OrePrefixes.gem, Materials.Olivine, 1 + aWorld.rand.nextInt(1 + aFortune)));
                break;
            case 12:
                rList.add(
                    GT_OreDictUnificator
                        .get(OrePrefixes.dust, Materials.Sodalite, 6 + 3 * aWorld.rand.nextInt(1 + aFortune)));
                if (aWorld.rand.nextInt(Math.max(1, 4 / (aFortune + 1))) == 0)
    ...
    public byte getStyle(IBlockAccess aWorld, int aX, int aY, int aZ) {
        ...
        if (tBlock != Blocks.air) {
            ...
            if (GT_OreDictUnificator.isItemStackInstanceOf(new ItemStack(tBlock, 1, tMeta), "stoneBlackGranite"))
                return +2;
            ...
            if (GT_OreDictUnificator.isItemStackInstanceOf(new ItemStack(tBlock, 1, tMeta), "stoneRedGranite"))
                return +3;
        ...
        try {
            if (aWorld instanceof World) {
                tBlock = aWorld.getBlock(aX + 1, aY, aZ);
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX + 1, aY, aZ, Blocks.stone))
                    return 0;
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX + 1, aY, aZ, Blocks.netherrack))
                    return -1;
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX + 1, aY, aZ, Blocks.end_stone))
                    return 1;
                tBlock = aWorld.getBlock(aX - 1, aY, aZ);
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX - 1, aY, aZ, Blocks.stone))
                    return 0;
                ...
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX - 1, aY, aZ, Blocks.end_stone))
                    return 1;
                tBlock = aWorld.getBlock(aX, aY + 1, aZ);
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY + 1, aZ, Blocks.stone))
                    return 0;
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY + 1, aZ, Blocks.netherrack))
                    return -1;
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY + 1, aZ, Blocks.end_stone))
                    return 1;
                tBlock = aWorld.getBlock(aX, aY - 1, aZ);
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY - 1, aZ, Blocks.stone))
                    return 0;
                ...
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY - 1, aZ, Blocks.end_stone))
                    return 1;
                tBlock = aWorld.getBlock(aX, aY, aZ + 1);
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY, aZ + 1, Blocks.stone))
                    return 0;
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY, aZ + 1, Blocks.netherrack))
                    return -1;
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY, aZ + 1, Blocks.end_stone))
                    return 1;
                tBlock = aWorld.getBlock(aX, aY, aZ - 1);
                if (tBlock != null && tBlock.isReplaceableOreGen((World) aWorld, aX, aY, aZ - 1, Blocks.stone))
                    return 0;
    ...
    public IIcon getIcon(IBlockAccess aWorld, int aX, int aY, int aZ, int aSide) {
        ...
        switch (getStyle(aWorld, aX, aY, aZ)) {
            case -1:
                if (!GT_Mod.sInvisibleOres || tSide % 12 > 6) return mIconsNether[aIndex];
                else return Blocks.netherrack.getBlockTextureFromSide(aSide);
            case 0:
                if (!GT_Mod.sInvisibleOres || tSide % 12 > 6) return mIconsStone[aIndex];
                else return Blocks.stone.getBlockTextureFromSide(aSide);
            case +1:
                if (!GT_Mod.sInvisibleOres || tSide % 12 > 6) return mIconsEnd[aIndex];
                else return Blocks.end_stone.getBlockTextureFromSide(aSide);
            case +2:
                if (!GT_Mod.sInvisibleOres || tSide % 12 > 6) return mIconsBlack[aIndex];
                else return GregTech_API.sBlockList[5].getIcon(aSide, 0);
            case +3:
                if (!GT_Mod.sInvisibleOres || tSide % 12 > 6) return mIconsRed[aIndex];
                else return GregTech_API.sBlockList[5].getIcon(aSide, 8);
            default:
