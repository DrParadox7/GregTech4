...
public class GT_BlockMetaID_Block2 extends Block {
    ...
    public IIcon getIcon(IBlockAccess aWorld, int xCoord, int yCoord, int zCoord, int aSide) {
        ...
        if ((tMeta != 8 && tMeta != 9 && tMeta != 13) || (xCoord == 0 && yCoord == 0 && zCoord == 0)
            || !GT_BlockMetaID_Block.mConnectedMachineTextures) return this.getIcon(aSide, tMeta);
    ...
    public boolean canEntityDestroy(IBlockAccess world, int x, int y, int z, Entity entity) {
        if (entity instanceof IBossDisplayData && world.getBlockMetadata(x, y, z) == 9) { // Make wither unable to break
