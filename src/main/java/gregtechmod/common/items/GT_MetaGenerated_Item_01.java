...
public class GT_MetaGenerated_Item_01 extends GT_MetaGenerated_Item {
    ...
    public GT_MetaGenerated_Item_01() {
        super(
            "GregTech_MetaGenerated_Item_01",
            new OrePrefixes[] { OrePrefixes.dustTiny, OrePrefixes.dustSmall, OrePrefixes.dust, OrePrefixes.dustImpure,
                ...
                OrePrefixes.lense, OrePrefixes.round, OrePrefixes.bolt, OrePrefixes.screw, OrePrefixes.ring, null,
                OrePrefixes.cell, OrePrefixes.cellPlasma });
    }

    public final ItemStack addItem(int aID, String aUnlocalizedName, String aToolTip, IFoodStat aFoodBehavior,
    ...
    public String getOreDictString(OrePrefixes aPrefix, Materials aMaterial) {
        return aMaterial == Materials.Wood && aPrefix == OrePrefixes.plate ? "plankWood"
            : super.getOreDictString(aPrefix, aMaterial);
    }
    ...
    public boolean doesShowInCreative(OrePrefixes aPrefix, Materials aMaterial, boolean aDoShowAllItems) {
        return aDoShowAllItems || aPrefix != OrePrefixes.nugget && aPrefix != OrePrefixes.dustTiny
            ...
            && aPrefix != OrePrefixes.cellPlasma;
    }
    ...
    public boolean doesMaterialAllowGeneration(OrePrefixes aPrefix, Materials aMaterial) {
        if (!super.doesMaterialAllowGeneration(aPrefix, aMaterial)) {
            ...
            switch (aPrefix) {
                ...
                case plate:
                    return (aMaterial.mTypes & 6) != 0 || aMaterial == Materials.Paper
                        || aMaterial == Materials.Redstone
                        || aMaterial == Materials.GraniteRed
                        || aMaterial == Materials.GraniteBlack
                        || aMaterial == Materials.Glowstone
                        || aMaterial == Materials.Nikolite
                        || aMaterial == Materials.Electrotine
                ...
                case stick:
                    return (aMaterial.mTypes & 2) != 0;
                case lense:
                    return (aMaterial.mTypes & 4) != 0 && aMaterial.mTransparent && aMaterial.mColor != Dyes._NULL
