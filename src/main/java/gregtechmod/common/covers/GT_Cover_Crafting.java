...
public class GT_Cover_Crafting extends GT_CoverBehavior {
    ...
    public boolean onCoverRightclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity,
        ...
        if (aPlayer instanceof EntityPlayerMP) {
            ...
            tMPPlayer.playerNetServerHandler
                .sendPacket(new S2DPacketOpenWindow(tMPPlayer.currentWindowId, 1, "Crafting", 9, true));
            tMPPlayer.openContainer = new ContainerWorkbench(
                tMPPlayer.inventory,
                tMPPlayer.worldObj,
