...
public class GT_Cover_EUMeter extends GT_CoverBehavior {
        ...
        if (aCoverVariable < 2) {
            ...
            if (tScale > 0) {
                aTileEntity.setOutputRedstoneSignal(
                    aSide,
                    aCoverVariable % 2 == 0 ? (byte) (aTileEntity.getUniversalEnergyStored() / tScale)
                        : (byte) (15 - (aTileEntity.getUniversalEnergyStored() / tScale)));
            } else {
            ...
            if (tScale > 0) {
                aTileEntity.setOutputRedstoneSignal(
                    aSide,
                    aCoverVariable % 2 == 0 ? (byte) (aTileEntity.getStoredEU() / tScale)
                        : (byte) (15 - (aTileEntity.getStoredEU() / tScale)));
            } else {
                aTileEntity.setOutputRedstoneSignal(aSide, aCoverVariable % 2 == 0 ? (byte) 0 : 15);
            }
            ...
            if (tScale > 0) {
                aTileEntity.setOutputRedstoneSignal(
                    aSide,
                    aCoverVariable % 2 == 0 ? (byte) (aTileEntity.getStoredRF() / tScale)
                        : (byte) (15 - (aTileEntity.getStoredRF() / tScale)));
            } else {
                aTileEntity.setOutputRedstoneSignal(aSide, aCoverVariable % 2 == 0 ? (byte) 0 : 15);
            }
            ...
            if (tScale > 0) {
                aTileEntity.setOutputRedstoneSignal(
                    aSide,
                    aCoverVariable % 2 == 0 ? (byte) (aTileEntity.getStoredSteam() / tScale)
                        : (byte) (15 - (aTileEntity.getStoredSteam() / tScale)));
            } else {
                aTileEntity.setOutputRedstoneSignal(aSide, aCoverVariable % 2 == 0 ? (byte) 0 : 15);
            }
            ...
            if (tScale > 0) {
                aTileEntity.setOutputRedstoneSignal(
                    aSide,
                    aCoverVariable % 2 == 0 ? (byte) (aTileEntity.getAverageElectricInput() / tScale)
                        : (byte) (15 - (aTileEntity.getAverageElectricInput() / tScale)));
            } else {
                aTileEntity.setOutputRedstoneSignal(aSide, aCoverVariable % 2 == 0 ? (byte) 0 : 15);
            }
            ...
            if (tScale > 0) {
                aTileEntity.setOutputRedstoneSignal(
                    aSide,
                    aCoverVariable % 2 == 0 ? (byte) (aTileEntity.getAverageElectricOutput() / tScale)
                        : (byte) (15 - (aTileEntity.getAverageElectricOutput() / tScale)));
            } else {
                aTileEntity.setOutputRedstoneSignal(aSide, aCoverVariable % 2 == 0 ? (byte) 0 : 15);
            }
        }
    ...
    public int onCoverScrewdriverclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity,
        ...
        GT_Utility.sendChatToPlayer(
            aPlayer,
            new ChatComponentTranslation("metatileentity.cover.drain.eu_meter." + aCoverVariable));
        return aCoverVariable;
    }
