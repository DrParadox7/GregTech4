...
public class GT_Cover_RedstoneConductor extends GT_CoverBehavior {
    ...
    public int doCoverThings(byte aSide, byte aInputRedstone, int aCoverID, int aCoverVariable,
        ...
        else if (aCoverVariable < 7) aTileEntity
            .setOutputRedstoneSignal(aSide, aTileEntity.getInternalInputRedstoneSignal((byte) (aCoverVariable - 1)));
    ...
    public int onCoverScrewdriverclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity,
        ...
        GT_Utility.sendChatToPlayer(
            aPlayer,
            new ChatComponentTranslation("metatileentity.cover.redstone_conductor." + aCoverVariable));
        return aCoverVariable;
    }
