...
public class GT_Cover_DoesWork extends GT_CoverBehavior {
    ...
    public int doCoverThings(byte aSide, byte aInputRedstone, int aCoverID, int aCoverVariable,
        ...
        if (aTileEntity instanceof IMachineProgress) {
            if (aCoverVariable < 2) {
                ...
                aTileEntity.setOutputRedstoneSignal(
                    aSide,
                    ((aCoverVariable % 2 == 0) != (((IMachineProgress) aTileEntity).getMaxProgress() == 0)) ? (byte) 0
                        : 15);
            }
        } else {
    ...
    public int onCoverScrewdriverclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity,
        ...
        if (aCoverVariable < 2) GT_Utility
            .sendChatToPlayer(aPlayer, new ChatComponentTranslation("metatileentity.cover.work." + aCoverVariable));
        else GT_Utility
            .sendChatToPlayer(aPlayer, new ChatComponentTranslation("metatileentity.cover.work_1." + aCoverVariable));
        return aCoverVariable;
    }
