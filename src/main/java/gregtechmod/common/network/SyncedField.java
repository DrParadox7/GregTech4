...
public final class SyncedField<T> {
    ...
    public final static Gson GSON = new GsonBuilder().disableHtmlEscaping()
        .serializeNulls()
        .create();
    ...
    public void writeChanges(JsonObject data, boolean force) {
        try {
            if ((objectValue == null && memberValue != null) || (objectValue != null && memberValue == null)
                || !(clz.isArray() ? Arrays.equals((Object[]) objectValue, (Object[]) memberValue)
                    : objectValue.equals(memberValue))
                || force) {
