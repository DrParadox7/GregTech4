...
public class GT_Container_ElectricFilter extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(final int aSlotIndex, final int aMouseclick, final int aShifthold,
        ...
        if (tSlot != null) {
            ...
            GT_MetaTileEntity_ElectricFilter mte = (GT_MetaTileEntity_ElectricFilter) this.mTileEntity
                .getMetaTileEntity();
            if (aSlotIndex == 18) {
                ...
                if (aPlayer.worldObj.isRemote) GT_Utility.sendChatToPlayer(
                    aPlayer,
                    new ChatComponentTranslation("metatileentity.status.ignore_nbt." + mte.bIgnoreNBT));
                return null;
            }
        }
        return super.slotClick(aSlotIndex, aMouseclick, aShifthold, aPlayer);
