...
public class GT_Container_ElectricSorter extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (tSlot != null) {
            ...
            if (aSlotIndex < 10) {
                ...
                ((GT_MetaTileEntity_ElectricSorter) mTileEntity
                    .getMetaTileEntity()).mTargetDirection = (byte) ((((GT_MetaTileEntity_ElectricSorter) mTileEntity
    ...
    public void prepareChanges(JsonObject data, boolean force) {
        ...
        mTargetDirection.updateAndWriteChanges(
            data,
            force,
            ((GT_MetaTileEntity_ElectricSorter) mTileEntity.getMetaTileEntity()).mTargetDirection);
    }
