...
public class GT_Container_Teleporter extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (inventorySlots.get(aSlotIndex) != null) {
            switch (aSlotIndex) {
                case 0:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetX -= (aShifthold == 1 ? 512
                        : 64);
                    return null;
                case 1:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetY -= (aShifthold == 1 ? 512
                        : 64);
                    return null;
                case 2:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetZ -= (aShifthold == 1 ? 512
                        : 64);
                    return null;
                case 3:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetD = this
                        .getNextWorldId(aShifthold == 1 ? 16 : 8, true);
                    return null;
                case 4:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetX -= (aShifthold == 1 ? 16
                        : 1);
                    return null;
                case 5:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetY -= (aShifthold == 1 ? 16
                        : 1);
                    return null;
                case 6:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetZ -= (aShifthold == 1 ? 16
                        : 1);
                    return null;
                case 7:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetD = this
                        .getNextWorldId(aShifthold == 1 ? 4 : 1, true);
                    return null;
                case 8:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetX += (aShifthold == 1 ? 512
                        : 64);
                ...
                case 11:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetD = this
                        .getNextWorldId(aShifthold == 1 ? 16 : 8, false);
                    return null;
                case 12:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetX += (aShifthold == 1 ? 16
                        : 1);
                ...
                case 15:
                    ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetD = this
                        .getNextWorldId(aShifthold == 1 ? 4 : 1, false);
                    return null;
            }
        }
    ...
    private int getNextWorldId(int intValue, boolean desc) {
        ...
        newIdx = idx + offset;
        return newIdx < 0 || newIdx >= IDs.size()
            ? ((GT_MetaTileEntity_Teleporter) mTileEntity.getMetaTileEntity()).mTargetD
            : IDs.get(newIdx);
    }
