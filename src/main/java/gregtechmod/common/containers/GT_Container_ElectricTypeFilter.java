...
public class GT_Container_ElectricTypeFilter extends GT_ContainerMetaTile_Machine {
    ...
    public GT_Container_ElectricTypeFilter(final InventoryPlayer aInventoryPlayer,
    ...
    public ItemStack slotClick(final int aSlotIndex, final int aMouseclick, final int aShifthold,
        ...
        if (tSlot != null) {
            ...
            GT_MetaTileEntity_ElectricTypeFilter mte = (GT_MetaTileEntity_ElectricTypeFilter) this.mTileEntity
                .getMetaTileEntity();
            ...
            if (aSlotIndex == 9) {
                ...
                if (aPlayer.worldObj.isRemote) GT_Utility.sendChatToPlayer(
                    ...
                    new ChatComponentTranslation(
                        "metatileentity.status.filter." + (mte.bInvertFilter ? "invert" : "normal")));
                return null;
            } else if (aSlotIndex == 14) {
                mte.bNBTAllowed = !mte.bNBTAllowed;
                if (aPlayer.worldObj.isRemote) GT_Utility.sendChatToPlayer(
                    aPlayer,
                    new ChatComponentTranslation("metatileentity.status.items_with_nbt." + mte.bNBTAllowed));
                return null;
            }
        }
        return super.slotClick(aSlotIndex, aMouseclick, aShifthold, aPlayer);
