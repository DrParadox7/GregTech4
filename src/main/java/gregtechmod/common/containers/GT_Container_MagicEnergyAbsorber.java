...
public class GT_Container_MagicEnergyAbsorber extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (tSlot != null) {
            ...
            if (aSlotIndex == 2) {
                ((GT_MetaTileEntity_MagicEnergyAbsorber) mTileEntity
                    .getMetaTileEntity()).isActive1 = !((GT_MetaTileEntity_MagicEnergyAbsorber) mTileEntity
                        .getMetaTileEntity()).isActive1;
                return null;
            } else if (aSlotIndex == 3) {
                ((GT_MetaTileEntity_MagicEnergyAbsorber) mTileEntity
                    .getMetaTileEntity()).isActive2 = !((GT_MetaTileEntity_MagicEnergyAbsorber) mTileEntity
                        .getMetaTileEntity()).isActive2;
                return null;
            }
        }
    ...
    public void prepareChanges(JsonObject data, boolean force) {
        ...
        isActive1.updateAndWriteChanges(
            data,
            force,
            ((GT_MetaTileEntity_MagicEnergyAbsorber) mTileEntity.getMetaTileEntity()).isActive1);
        isActive2.updateAndWriteChanges(
            data,
            force,
            ((GT_MetaTileEntity_MagicEnergyAbsorber) mTileEntity.getMetaTileEntity()).isActive2);
    }
