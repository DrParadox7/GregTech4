    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        try {
            ...
            if (aSlotIndex == 32) {
                ...
                ItemStack tStack2,
                    tCraftedStack = ((GT_MetaTileEntity_BronzeCraftingTable) mTileEntity.getMetaTileEntity())
                        .getCraftingOutput();
                        ...
                        for (byte i = 0; i < aPlayer.inventory.mainInventory.length; i++) {
                            for (byte j = 0; j < tCraftedStack.getMaxStackSize() / tCraftedStack.stackSize
                                ...
                                if (!GT_Utility.areStacksEqual(
                                    tStack2 = ((GT_MetaTileEntity_BronzeCraftingTable) mTileEntity.getMetaTileEntity())
                                        .getCraftingOutput(),
                                    tCraftedStack) || tStack.stackSize != tStack2.stackSize)
                                    return aPlayer.inventory.getItemStack();
                                aPlayer.inventory.mainInventory[i] = (((GT_MetaTileEntity_BronzeCraftingTable) mTileEntity
                                    .getMetaTileEntity())
