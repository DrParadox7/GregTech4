...
public class GT_Container_ElectricInventoryManager extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        if (tSlot != null) {
            ...
            if (aSlotIndex < 15) {
                ...
                if (aMouseclick != 0) ((GT_MetaTileEntity_ElectricInventoryManager) mTileEntity.getMetaTileEntity())
                    .switchSlot1InOut((aSlotIndex - 15) / 3);
                else((GT_MetaTileEntity_ElectricInventoryManager) mTileEntity.getMetaTileEntity())
    ...
    // mTargetInOut = 0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot1InOut(0)?1<< 0:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot2InOut(0)?1<< 1:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot3InOut(0)?1<< 2:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot1InOut(1)?1<< 3:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot2InOut(1)?1<< 4:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot3InOut(1)?1<< 5:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot1InOut(2)?1<< 6:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot2InOut(2)?1<< 7:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot3InOut(2)?1<< 8:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot1InOut(3)?1<< 9:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot2InOut(3)?1<<10:0;
    // mTargetInOut |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getSlot3InOut(3)?1<<11:0;
    //
    // mTargetEnergy = 0;
    // mTargetEnergy |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getRangeEnergy(0)?1<<0:0;
    // mTargetEnergy |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getRangeEnergy(1)?1<<1:0;
    // mTargetEnergy |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getRangeEnergy(2)?1<<2:0;
    // mTargetEnergy |=
    // ((GT_MetaTileEntity_ElectricInventoryManager)mTileEntity.getMetaTileEntity()).getRangeEnergy(3)?1<<3:0;
    // }

    @Override
    public void prepareChanges(JsonObject data, boolean force) {
        super.prepareChanges(data, force);
        GT_MetaTileEntity_ElectricInventoryManager m = (GT_MetaTileEntity_ElectricInventoryManager) mTileEntity
            .getMetaTileEntity();
