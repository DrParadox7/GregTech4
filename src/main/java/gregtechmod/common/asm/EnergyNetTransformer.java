...
public class EnergyNetTransformer implements IClassTransformer {
    ...
    private void transformGrid(ClassNode node) {
        ...
        for (MethodNode meth : node.methods) { // Rewriting full method body
            if (meth.name.equals("finishCalculation") && meth.desc.equals("()V")) {
                 ...
                 * <localVar:index=1 , name=result , desc=Ljava/lang/Iterable;,
                 * sig=Ljava/lang/Iterable<Lic2/core/energy/Node;>;, start=L3, end=L4>
                 * <localVar:index=2 , name=networkTier , desc=I, sig=null, start=L5, end=L4>
                 * <localVar:index=3 , name=changes , desc=Ljava/util/List;,
                 * sig=Ljava/util/List<Lic2/core/energy/Change;>;, start=L6, end=L4>
                 * <localVar:index=4 , name=node , desc=Lic2/core/energy/Node;, sig=null, start=L7, end=L8>
                 * <localVar:index=6 , name=dir , desc=Lnet/minecraftforge/common/util/ForgeDirection;, sig=null,
                 * start=L9, end=L10>
                 * <localVar:index=6 , name=dir , desc=Lnet/minecraftforge/common/util/ForgeDirection;, sig=null,
                 * start=L11, end=L8>
                 ...
                 * <localVar:index=1 , name=e2 , desc=Ljava/util/concurrent/ExecutionException;, sig=null, start=L16,
                 * end=L17>
                ...
                for (int i = 0; i < labels.length; i++) labels[i] = new LabelNode(new Label());

                meth.localVariables
                    .add(new LocalVariableNode("this", getType(gridClass), null, labels[0], labels[1], 0));
                meth.localVariables
                    .add(new LocalVariableNode("result", getType(iterableClass), null, labels[2], labels[3], 1));
                meth.localVariables.add(new LocalVariableNode("networkTier", "I", null, labels[4], labels[3], 2));
                meth.localVariables
                    .add(new LocalVariableNode("changes", "Ljava/util/List;", null, labels[5], labels[3], 3));
                meth.localVariables
                    .add(new LocalVariableNode("node", getType(nodeClass), null, labels[6], labels[7], 4));
                meth.localVariables
                    .add(new LocalVariableNode("dir", getType(directionClass), null, labels[8], labels[9], 6));
                meth.localVariables
                    .add(new LocalVariableNode("dir", getType(directionClass), null, labels[10], labels[7], 6));
                meth.localVariables
                    .add(new LocalVariableNode("change", getType(changeClass), null, labels[11], labels[12], 4));
                meth.localVariables.add(
                ...
                meth.localVariables.add(
                    new LocalVariableNode(
                        ...
                        1));
                meth.localVariables
                    .add(new LocalVariableNode("ps", "Ljava/io/PrintStream;", null, labels[17], labels[16], 2));

                meth.tryCatchBlocks
                    .add(new TryCatchBlockNode(labels[18], labels[3], labels[19], "java/lang/InterruptedException"));
                meth.tryCatchBlocks.add(
                ...
                inss.add(new LineNumberNode(++line, labels[5]));
                {
                    ...
                    inss.add(
                        new MethodInsnNode(INVOKEINTERFACE, iterableClass, "iterator", "()Ljava/util/Iterator;", true));
                ...
                inss.add(new LineNumberNode(line, labels[22]));
                {
                    inss.add(
                        new FrameNode(
                            F_NEW,
                            6,
                            new Object[] { gridClass, "java/lang/Iterable", 1, "java/util/List", 0,
                                "java/util/Iterator" },
                            0,
                            new Object[0]));
                ...
                inss.add(new LineNumberNode(++line, labels[23]));
                {
                    ...
                    inss.add(new InsnNode(ICONST_0));
                    inss.add(
                        new MethodInsnNode(INVOKEINTERFACE, "java/util/List", "get", "(I)Ljava/lang/Object;", true));
                    inss.add(new TypeInsnNode(CHECKCAST, "ic2/core/energy/NodeLink"));
                    inss.add(new VarInsnNode(ALOAD, 4));
                    inss.add(
                        new MethodInsnNode(
                            INVOKEVIRTUAL,
                            "ic2/core/energy/NodeLink",
                            "getDirFrom",
                            String.format("(L%s;)L%s;", nodeClass, directionClass),
                            false));
                ...
                inss.add(new LineNumberNode(line += 3, labels[9]));
                {
                    inss.add(
                        new FrameNode(
                            F_NEW,
                            6,
                            new Object[] { gridClass, "java/lang/Iterable", 1, "java/util/List", nodeClass,
                                "java/util/Iterator" },
                            0,
                            new Object[0]));
                ...
                inss.add(new LineNumberNode(++line, labels[25]));
                {
                    ...
                    inss.add(
                        new MethodInsnNode(
                            ...
                            "ic2/core/util/Log",
                            "warn",
                            "(Lic2/core/util/LogCategory;Ljava/lang/String;[Ljava/lang/Object;)V",
                            false));
                }
                ...
                inss.add(new LineNumberNode(++line, labels[26]));
                {
                    ...
                    inss.add(
                        new MethodInsnNode(
                            ...
                            "ic2/core/util/Log",
                            "getPrintStream",
                            "(Lic2/core/util/LogCategory;Lorg/apache/logging/log4j/Level;)Ljava/io/PrintStream;",
                            false));
                    inss.add(new InsnNode(ICONST_0));
                    inss.add(new VarInsnNode(ALOAD, 4));
                    inss.add(
                        new MethodInsnNode(
                            ...
                            gridClass,
                            "dumpNodeInfo",
                            "(Ljava/io/PrintStream;ZLic2/core/energy/Node;)V",
                            false));
                }
                ...
                inss.add(new LineNumberNode(line += 4, labels[24]));
                {
                    inss.add(
                        new FrameNode(
                            ...
                            7,
                            new Object[] { gridClass, "java/lang/Iterable", 1, "java/util/List", nodeClass,
                                "java/util/Iterator", directionClass },
                            0,
                            new Object[0]));
                    inss.add(new VarInsnNode(ALOAD, 4));
                    ...
                    inss.add(
                        new FieldInsnNode(
                            GETSTATIC,
                            "ic2/core/energy/NodeType",
                            "Source",
                            "Lic2/core/energy/NodeType;"));
                ...
                inss.add(new LineNumberNode(line += 3, labels[28]));
                {
                    ...
                    inss.add(
                        new MethodInsnNode(
                            ...
                            changeClass,
                            "<init>",
                            String.format("(L%s;L%s;DDI)V", nodeClass, directionClass),
                            false));
                    inss.add(
                        new MethodInsnNode(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true));
                ...
                inss.add(new LineNumberNode(line += 2, labels[32]));
                {
                    ...
                    inss.add(
                        new FieldInsnNode(GETFIELD, "ic2/core/energy/EnergyNetLocal", "changes", "Ljava/util/List;"));
                    inss.add(new VarInsnNode(ALOAD, 3));
                    inss.add(
                        new MethodInsnNode(
                            INVOKEINTERFACE,
                ...
                inss.add(new LineNumberNode(++line, labels[13]));
                {
                    ...
                    inss.add(
                        new MethodInsnNode(
                            ...
                            "ic2/core/util/Log",
                            "debug",
                            "(Lic2/core/util/LogCategory;Ljava/lang/Throwable;Ljava/lang/String;)V",
                            false));
                }
                ...
                inss.add(new LineNumberNode(++line, labels[20]));
                {
                    inss.add(
                        new FrameNode(
                            ...
                            new Object[] { gridClass },
                            1,
                            new Object[] { "java/util/concurrent/ExecutionException" }));
                    inss.add(new VarInsnNode(ASTORE, 1));
                }
                ...
                inss.add(new LineNumberNode(++line, labels[17]));
                {
                    ...
                    inss.add(new InsnNode(ICONST_0));
                    inss.add(
                        new MethodInsnNode(INVOKEVIRTUAL, gridClass, "dumpStats", "(Ljava/io/PrintStream;Z)V", false));
                }
    ...
    private void transformEnergyNetLocal(ClassNode node) {
        ...
        for (MethodNode meth : node.methods) {
            if ((meth.name.equals("addChange")
                && meth.desc.equals("(Lic2/core/energy/Node;Lnet/minecraftforge/common/util/ForgeDirection;DD)V"))
                || meth.name.equals("processChanges")) {
                ...
                for (int i = 0; i < meth.instructions.size(); i++) {
                    ...
                    if (ins.getOpcode() == INVOKESPECIAL || ins.getOpcode() == INVOKEINTERFACE) {
                        ...
                        if (call.name.equals("<init>") && call.owner.equals(changeClass)) {
                            ...
                            GT_CoreMod.log.info(
                                "EnergyNetLocal#processChanges changed call of IEnergySink#injectEnergy to default generated method");
                            meth.instructions.insertBefore(ins, new VarInsnNode(ALOAD, 2));
                            meth.instructions
                                .insertBefore(ins, new FieldInsnNode(GETFIELD, changeClass, "netSourceTier", "I"));
    ...
    private void transformInterface(ClassNode node) {
        ...
        MethodNode newMeth = (MethodNode) node.visitMethod(
            ACC_PUBLIC,
            methName,
            "(Lnet/minecraftforge/common/util/ForgeDirection;DDI)D",
            null,
            new String[0]);
        ...
        newMeth.localVariables.add(
            new LocalVariableNode("directionFrom", "Lnet/minecraftforge/common/util/ForgeDirection;", null, L1, L2, 1));
        ...
        newMeth.instructions.add(L1);
        {
            ...
            newMeth.instructions.add(
                new MethodInsnNode(
                    INVOKEINTERFACE,
                    clazz,
                    methName,
                    "(Lnet/minecraftforge/common/util/ForgeDirection;DD)D",
                    true));
    ...
    static {
        workingClasses = Arrays.asList(
            new String[] { GT_CoreMod.getIC2APIClass("energy.tile.IEnergySink"),
                GT_CoreMod.getIC2CoreClass("energy.Change"), GT_CoreMod.getIC2CoreClass("energy.EnergyNetLocal"),
