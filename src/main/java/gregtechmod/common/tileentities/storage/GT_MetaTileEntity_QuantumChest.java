...
public class GT_MetaTileEntity_QuantumChest extends GT_MetaTileEntity_DigitalChest {
    ...
    public void onConfigLoad(GT_Config aConfig) {
        sQuantumItemCount = Math.max(
            GT_MetaTileEntity_DigitalChest.sDigitalItemCount,
            aConfig.get(GT_ConfigCategories.machineconfig, "QuantumChest.MaxItems", sQuantumItemCount));
    }
