...
public class GT_MetaTileEntity_Shelf extends MetaTileEntity {
        ...
        if (tStack == null) {
            ...
            if (mInventory[0] == null) {
                if (OrePrefixes.paper.contains(tStack)) {
                    ...
                    tStack,
                    GT_ModHandler.getIC2Item("filledTinCan", 1, GregTech_API.ITEM_WILDCARD_DAMAGE))
                    || GT_Utility.areStacksEqual(
                        tStack,
                        GT_ModHandler.getIC2Item("tinCan", 1, GregTech_API.ITEM_WILDCARD_DAMAGE))) {
                            aPlayer.inventory.setInventorySlotContents(aPlayer.inventory.currentItem, null);
                            getBaseMetaTileEntity().setInventorySlotContents(0, tStack);
                            mType = 3;
                        }
    ...
    public String getDescription() {
        return "metatileentity.GT_Shelf.tooltip";
    }
