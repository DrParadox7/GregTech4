...
public class TileEntitySuperconductor extends BaseTileEntity
    implements IEnergyConductor, ITexturesTileEntity, IWrenchable {
    ...
    public double getInsulationEnergyAbsorption() {
        return GregTech_API.VOLTAGE_INSANE;
    }
    ...
    public int getTextureIndex(byte aSide, byte aMeta) {
        ...
        boolean[] tConnectedSides = { this.getTileEntityAtSide((byte) 0) instanceof IEnergyTile,
