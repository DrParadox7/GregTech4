...
public class GT_MetaTileEntity_RedstoneNoteBlock extends MetaTileEntity {
    ...
    public GT_MetaTileEntity_RedstoneNoteBlock(int aID, String mName) {
        super(aID, mName);
    }
    ...
    public void doSound(byte aIndex, double aX, double aY, double aZ) {
        ...
        switch (getBaseMetaTileEntity().getFrontFacing()) {
            case 1:
                tStack = new ItemStack(Blocks.gold_block, 1);
                break;
            case 2:
                tStack = new ItemStack(Blocks.stone, 1);
                break;
            case 3:
                tStack = new ItemStack(Blocks.sand, 1);
                break;
            case 4:
                tStack = new ItemStack(Blocks.glass, 1);
                break;
            case 5:
                tStack = new ItemStack(Blocks.log, 1);
                break;
            default:
                tStack = new ItemStack(Blocks.iron_block, 1);
                break;
        }
        ...
        getBaseMetaTileEntity().getWorld()
            .spawnParticle("note", aX, aY + 0.7, aZ, aIndex / 14.0, 0.0, 0.0);
    }
