...
public class GT_MetaTileEntity_BronzeBlastFurnace extends BaseMultiWorkable {
    ...
    public boolean allowCoverOnSide(byte aSide, int aCoverID) {
        return GregTech_API.getCoverBehavior(aCoverID)
    ...
    protected boolean checkMachine() {
        ...
        for (int i = -1; i < 2; i++)
            for (int j = -1; j < 3; j++) for (int k = -1; k < 2; k++) if (xDir + i != 0 || j != 0 || zDir + k != 0) {
                if (i != 0 || j == -1 || k != 0) {
                    if (getBaseMetaTileEntity().getBlockOffset(xDir + i, j, zDir + k) != GregTech_API.sBlockList[4]
                        || getBaseMetaTileEntity().getMetaIDOffset(xDir + i, j, zDir + k) != 13) return false;
                } else {
                    if (getBaseMetaTileEntity().getBlockOffset(xDir + i, j, zDir + k) != Blocks.lava
                        && !getBaseMetaTileEntity().getAirOffset(xDir + i, j, zDir + k)) return false;
                }
            }
        return true;
    }
    ...
    public void onPostTick() {
        if (getBaseMetaTileEntity().isClientSide()) {
            if (getBaseMetaTileEntity().isActive()) {
                getBaseMetaTileEntity().getWorld()
                    .spawnParticle(
                        "largesmoke",
                        getBaseMetaTileEntity().getOffsetX(getBaseMetaTileEntity().getBackFacing(), 1) + Math.random(),
                        getBaseMetaTileEntity().getOffsetY(getBaseMetaTileEntity().getBackFacing(), 1),
                        getBaseMetaTileEntity().getOffsetZ(getBaseMetaTileEntity().getBackFacing(), 1) + Math.random(),
                        0,
                        0.3,
                        0);
            }
        ...
        if (getBaseMetaTileEntity().isServerSide()) {
            ...
            if (recipeLogic.isActive()) {
                if (getBaseMetaTileEntity().getAir(
                    getBaseMetaTileEntity().getOffsetX(getBaseMetaTileEntity().getBackFacing(), 1),
                    getBaseMetaTileEntity().getYCoord(),
                    getBaseMetaTileEntity().getOffsetZ(getBaseMetaTileEntity().getBackFacing(), 1)))
                    getBaseMetaTileEntity().getWorld()
                        .setBlock(
                            getBaseMetaTileEntity().getOffsetX(getBaseMetaTileEntity().getBackFacing(), 1),
                            getBaseMetaTileEntity().getYCoord(),
                ...
                if (getBaseMetaTileEntity().getAir(
                    getBaseMetaTileEntity().getOffsetX(getBaseMetaTileEntity().getBackFacing(), 1),
                    getBaseMetaTileEntity().getYCoord() + 1,
                    getBaseMetaTileEntity().getOffsetZ(getBaseMetaTileEntity().getBackFacing(), 1)))
                    getBaseMetaTileEntity().getWorld()
                        .setBlock(
                            getBaseMetaTileEntity().getOffsetX(getBaseMetaTileEntity().getBackFacing(), 1),
                ...
                if (getBaseMetaTileEntity().getBlock(
                    getBaseMetaTileEntity().getOffsetX(getBaseMetaTileEntity().getBackFacing(), 1),
                    getBaseMetaTileEntity().getYCoord(),
                    getBaseMetaTileEntity().getOffsetZ(getBaseMetaTileEntity().getBackFacing(), 1)) == Blocks.lava)
                    getBaseMetaTileEntity().getWorld()
                        .setBlock(
                            getBaseMetaTileEntity().getOffsetX(getBaseMetaTileEntity().getBackFacing(), 1),
                            getBaseMetaTileEntity().getYCoord(),
            ...
            if (base.isAllowedToWork()) {
                ...
                if (progressTime == 0) {
                    if (base.hasInventoryBeenModified() || base.hasWorkJustBeenEnabled()
                        || success
                        || base.getTimer() % 600 == 0) {// || isInputNonEmpty()) {
                        trySerachRecipe();
                    }
                }
            }
