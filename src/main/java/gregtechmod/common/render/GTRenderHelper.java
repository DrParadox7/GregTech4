...
public class GTRenderHelper {
    ...
    public static void drawStackAmount(int posX, int posY, int color, String str) {
        ...
        mc.fontRenderer
            .drawStringWithShadow(str, posX + 19 - 2 - mc.fontRenderer.getStringWidth(str), posY + 6 + 3, color);
    }
    ...
    public static void drawQuad(double posX, double posY, double zIndex, double width, double height, double minU,
    ...
    public static void addQuadWithUV(double posX, double posY, double zIndex, double width, double height, double minU,
        double maxU, double minV, double maxV) {
