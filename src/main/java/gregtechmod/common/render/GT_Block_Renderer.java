...
public class GT_Block_Renderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess aWorld, int aX, int aY, int aZ, Block aBlock, int aModelID,
        ...
        switch (aMeta) {
            case 1:
                return renderPipeBlock(aWorld, aX, aY, aZ, aBlock, aModelID, aRenderer);
            case 2:
                return renderPipeBlock(aWorld, aX, aY, aZ, aBlock, aModelID, aRenderer);
            case 3:
                return renderPipeBlock(aWorld, aX, aY, aZ, aBlock, aModelID, aRenderer);
     ...
     */
    public boolean renderPipeBlock(IBlockAccess aWorld, int aX, int aY, int aZ, Block aBlock, int aModelID,
        RenderBlocks aRenderer) {
        ...
        if (aTileEntity instanceof BaseMetaPipeEntity) {
            ...
            byte tConnections = 0;
            for (byte i = 0; i < 6; i++)
                if ((tTileEntity.mConnections & (1 << i)) != 0) tConnections |= (1 << ((i + 2) % 6));
            ...
            for (byte i = 0; i < 6; i++) {
                tCovers[i] = aBlock.getIcon(aWorld, aX, aY, aZ, i);
                tIcons[i] = tTileEntity.getUncoveredIcon(i, (byte) 1);
                if (tIcons[i] == null) {
                    int tIndex = tTileEntity.getUncoveredIndex(i, (byte) 1);
                    if (tIndex >= 0 && tIndex < GT_BlockMetaID_Machine.mIcons.length)
                        tIcons[i] = GT_BlockMetaID_Machine.mIcons[tIndex];
                    if (tIcons[i] == null) {
            ...
            float tR = (float) (tC >> 16 & 255) / 300.0F, tG = (float) (tC >> 8 & 255) / 300.0F,
                tB = (float) (tC & 255) / 300.0F;
    ...
    public static void renderPositiveXFacing(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ,
        IIcon aIcon) {
        aRenderer.flipTexture = true;
    ...
    public static void renderPositiveYFacing(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ,
        IIcon aIcon) {
        aRenderer.renderFaceYPos(aBlock, aX, aY, aZ, aIcon);
    }

    public static void renderPositiveZFacing(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ,
        IIcon aIcon) {
        aRenderer.renderFaceZPos(aBlock, aX, aY, aZ, aIcon);
    }

    public static void renderNegativeXFacing(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ,
        IIcon aIcon) {
        aRenderer.renderFaceXNeg(aBlock, aX, aY, aZ, aIcon);
    }

    public static void renderNegativeYFacing(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ,
        IIcon aIcon) {
        aRenderer.renderFaceYNeg(aBlock, aX, aY, aZ, aIcon);
    }

    public static void renderNegativeZFacing(RenderBlocks aRenderer, Block aBlock, int aX, int aY, int aZ,
        IIcon aIcon) {
        aRenderer.flipTexture = true;
