        ...
        try {
            ...
            if (tResource != null && !aPlayer.getHideCape()) {
                ...
                double d0 = aPlayer.field_71091_bM
                    + (aPlayer.field_71094_bP - aPlayer.field_71091_bM) * (double) aPartialTicks
                    - (aPlayer.prevPosX + (aPlayer.posX - aPlayer.prevPosX) * (double) aPartialTicks);
                double d1 = aPlayer.field_71096_bN
                    + (aPlayer.field_71095_bQ - aPlayer.field_71096_bN) * (double) aPartialTicks
                    - (aPlayer.prevPosY + (aPlayer.posY - aPlayer.prevPosY) * (double) aPartialTicks);
                double d2 = aPlayer.field_71097_bO
                    + (aPlayer.field_71085_bR - aPlayer.field_71097_bO) * (double) aPartialTicks
                    - (aPlayer.prevPosZ + (aPlayer.posZ - aPlayer.prevPosZ) * (double) aPartialTicks);
