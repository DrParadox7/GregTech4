...
public class GT_FoodStat implements IFoodStat {
    ...
    public GT_FoodStat(int aFoodLevel, float aSaturation, EnumAction aAction, ItemStack aEmptyContainer,
        boolean aAlwaysEdible, boolean aInvisibleParticles, int... aPotionEffects) {
    ...
    public void onEaten(GT_MetaGenerated_Item aItem, ItemStack aStack, EntityPlayer aPlayer) {
        ...
        if (tStack != null && !aPlayer.inventory.addItemStackToInventory(tStack)) aPlayer.entityDropItem(tStack, 0);
        aPlayer.worldObj
