...
public interface IGregTechTileEntity
    extends IGearEnergyTileEntity, ICoverable, IFluidHandler, ITurnable, IGregTechDeviceInformation, IUpgradableMachine,
    IDigitalChest, IDescribable, IMachineBlockUpdateable, ITexturesTileEntity {
    ...
    /**
     * @return 0 - 15 are Colors, 16-31 are the same Colors but on a bleached Machine, while -1 means uncolored and -2
     *         means bleached.
     */
