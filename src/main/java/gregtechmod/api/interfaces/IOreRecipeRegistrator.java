...
public interface IOreRecipeRegistrator {
    ...
    /**
     * All checks from OrePrefixes and OreDictHandler classes was moved here, execute this method before executing
     * processor
     * 
     * @param aPrefix
     * @param aMaterial
    ...
    default boolean isExecutable(OrePrefixes aPrefix, Materials aMaterial) {
        return aMaterial != null && !aPrefix.isIgnored(aMaterial)
            && (aMaterial != Materials._NULL || aPrefix.mIsSelfReferencing || !aPrefix.mIsMaterialBased);
    }
