...
public class GT_Container_BasicMachine extends GT_ContainerMetaTile_Machine {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        ...
        return this.handleClick(aSlotIndex, aMouseclick, aShifthold, aPlayer) ? null
            : super.slotClick(aSlotIndex, aMouseclick, aShifthold, aPlayer);
    }
        ...
        if (mTileEntity.getMetaTileEntity() != null && tSlot != null) {
            if (aSlotIndex == 5) {
                ((GT_MetaTileEntity_BasicMachine) mTileEntity
                    .getMetaTileEntity()).bOutput = !((GT_MetaTileEntity_BasicMachine) mTileEntity
                        .getMetaTileEntity()).bOutput;
                return true;
            } else if (aSlotIndex == 6) {
                ((GT_MetaTileEntity_BasicMachine) mTileEntity
                    .getMetaTileEntity()).bItemTransfer = !((GT_MetaTileEntity_BasicMachine) mTileEntity
                        .getMetaTileEntity()).bItemTransfer;
                return true;
            } else if (aSlotIndex == 7) {
                ((GT_MetaTileEntity_BasicMachine) mTileEntity
                    .getMetaTileEntity()).bSeperatedInputs = !((GT_MetaTileEntity_BasicMachine) mTileEntity
                        .getMetaTileEntity()).bSeperatedInputs;
                return true;
            }
        }
