...
public class GT_EnergyStore_Item extends GT_Generic_Item {
    ...
    public GT_EnergyStore_Item(String aUnlocalized, int aCharge, int aTransfer, int aTier, int aEmptyID, int aFullID) { // TODO
                                                                                                                        // remove
                                                                                                                        // IDs
    ...
    public void getSubItems(Item item, CreativeTabs var2, List var3) {
        ItemStack tCharged = new ItemStack(GregTech_API.sItemList[mFullID], 1, 0),
            tUncharged = new ItemStack(GregTech_API.sItemList[mEmptyID], 1, getMaxDamage() - 1);
