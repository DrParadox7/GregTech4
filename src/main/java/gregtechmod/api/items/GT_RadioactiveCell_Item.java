...
public class GT_RadioactiveCell_Item extends GT_Generic_Item {
    ...
    public GT_RadioactiveCell_Item(String aUnlocalized, int aMaxDelay, int aCellcount, int aPulseRate,
        ItemStack aDepleted) {
    ...
    public void addAdditionalToolTips(List aList, ItemStack aStack) {
        ...
        aList.add(I18n.format("item.RadioactiveCell_Item.tooltip_1", maxDelay - getDurabilityOfStack(aStack)));
    }
}
