...
public class GT_Spray_Foam_Item extends GT_Tool_Item {
    ...
    public void switchMode(ItemStack aStack, EntityPlayer aPlayer) {
        ...
        switch (getMode(aStack)) {
            case 0:
                GT_Utility.sendChatToPlayer(aPlayer, new ChatComponentTranslation("item.GT_Spray_Foam.mode_1"));
                break;
            case 1:
                GT_Utility.sendChatToPlayer(aPlayer, new ChatComponentTranslation("item.GT_Spray_Foam.mode_2"));
                break;
            case 2:
                GT_Utility.sendChatToPlayer(aPlayer, new ChatComponentTranslation("item.GT_Spray_Foam.mode_3"));
                break;
        }
    }
    ...
    public void addAdditionalToolTips(List<String> aList, ItemStack aStack) {
        ...
        switch (getMode(aStack)) {
            case 0:
                aList.add(I18n.format("item.GT_Spray_Foam.mode_1"));
                break;
            case 1:
                aList.add(I18n.format("item.GT_Spray_Foam.mode_2"));
                break;
            case 2:
                aList.add(I18n.format("item.GT_Spray_Foam.mode_3"));
                break;
        }
    }
                ...
                case 0:
                    if (aWorld.isAirBlock(aX, aY, aZ) && GT_ModHandler.damageOrDechargeItem(aStack, 1, 1000, aPlayer)) {
                        ...
                        aWorld.setBlock(
                            ...
                            aY,
                            aZ,
                            Block.getBlockFromItem((ItemBlock) tStack.getItem()),
