        ...
        if (tString != null && tString.startsWith("ore")) {
            GT_Utility.sendChatToPlayer(
                ...
                new ChatComponentTranslation(
                    "gregtech.tool.hammer.ore.0",
                    new ChatComponentTranslation("materials." + tString.replaceFirst("ore", ""))));
            GT_Utility.sendSoundToPlayers(aWorld, GregTech_API.sSoundList.get(1), 1.0F, -1, aX, aY, aZ);
            return true;
        }

        if (aBlock.isReplaceableOreGen(aWorld, aX, aY, aZ, Blocks.stone)
            || aBlock.isReplaceableOreGen(aWorld, aX, aY, aZ, GregTech_API.sBlockList[5])
            ...
            if (GT_ModHandler.damageOrDechargeItem(aStack, 1, 1000, aPlayer)) {
                ...
                for (byte i = 0; i < 7; i++) {
                    ...
                    if (tBlock == Blocks.water || tBlock == Blocks.flowing_water
                        || (tBlock != null && tBlock instanceof IFluidBlock)) {
                        GT_Utility
                            .sendChatToPlayer(aPlayer, new ChatComponentTranslation("gregtech.tool.hammer.liquid"));
                        break;
                    }
                    ...
                    if (tBlock != aBlock) {
                        if (i < 4) GT_Utility
                            .sendChatToPlayer(aPlayer, new ChatComponentTranslation("gregtech.tool.hammer.diff"));
                        break;
                    }
                }
