...
public class GT_EnergyArmor_Item extends ItemArmor implements ISpecialArmor {
    ...
    public GT_EnergyArmor_Item(String aUnlocalized, int aCharge, int aTransfer, int aTier, int aDamageEnergyCost,
        int aSpecials, double aArmorAbsorbtionPercentage, boolean aChargeProvider, int aType, int aArmorIndex) {
    ...
    public void onArmorTick(World aWorld, EntityPlayer aPlayer, ItemStack aStack) {
        ...
        if (!aPlayer.worldObj.isRemote && (mSpecials & (16 | 32)) != 0) {
            if (GregTech_API.sWorldTickCounter % 20 == 0) {
                ...
                if (GT_ModHandler
                    .dischargeElectricItem(tTargetDechargeItem, 10, Integer.MAX_VALUE, true, true, true, true) < 10) {
                ...
                if (aPlayer.worldObj.isDaytime() && aPlayer.worldObj.canBlockSeeTheSky(
                    ...
                    if ((mSpecials & 16) != 0 && tTargetDechargeItem != null
                        ...
                        if (aPlayer.worldObj.isAirBlock((int) aPlayer.posX, (int) aPlayer.posY + 1, (int) aPlayer.posZ))
                            aPlayer.worldObj.setBlock(
                                (int) aPlayer.posX,
                                (int) aPlayer.posY + 1,
                                (int) aPlayer.posZ,
    ...
    public void onEntityLivingFallEvent(LivingFallEvent event) {
        if (!event.entity.worldObj.isRemote && event.entity instanceof EntityPlayer) {
            EntityPlayer var2 = (EntityPlayer) event.entity;
            for (int i = 0; i < 4; i++) {
                ItemStack var3 = var2.inventory.armorInventory[i];
                if (var3 != null && var3.getItem() == this && (mSpecials & 2) != 0) {
                    int var4 = (int) event.distance - 3;
                    int var5 = (this.mDamageEnergyCost * var4) / 4;
                    if (var5 <= GT_ModHandler
                        .dischargeElectricItem(var3, Integer.MAX_VALUE, Integer.MAX_VALUE, true, true, true, true)) {
                        GT_ModHandler.dischargeElectricItem(var3, var5, Integer.MAX_VALUE, true, false, true, true);
    ...
    public ISpecialArmor.ArmorProperties getProperties(EntityLivingBase var1, ItemStack var2, DamageSource var3,
        ...
        return new ISpecialArmor.ArmorProperties(
            ...
            mDamageEnergyCost > 0 ? (int) (25 * GT_ModHandler
                .dischargeElectricItem(var2, Integer.MAX_VALUE, Integer.MAX_VALUE, true, true, true, true))
                / mDamageEnergyCost : 0);
    }
    ...
    public void damageArmor(EntityLivingBase var1, ItemStack var2, DamageSource var3, int var4, int var5) {
        GT_ModHandler.dischargeElectricItem(var2, var4 * mDamageEnergyCost, Integer.MAX_VALUE, true, false, true, true);
    }
