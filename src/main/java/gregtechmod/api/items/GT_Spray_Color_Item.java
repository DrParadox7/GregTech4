...
public class GT_Spray_Color_Item extends GT_Tool_Item {
    ...
    public void addAdditionalToolTips(List aList, ItemStack aStack) {
        aList.add(
            I18n.format(
                "item.GT_Spray_Color_Item.tooltip_3",
                getMaxDamage(),
                Dyes.get(mColorMeta).mName.toLowerCase()));
    ...
    public boolean onItemUseFirst(ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ,
        ...
        if (aBlock == Blocks.carpet || aBlock == Blocks.hardened_clay
            || aBlock == Blocks.stained_hardened_clay
            || aBlock == GT_Items.TE_Rockwool.getBlock()) {
            ...
            if (GT_ModHandler.damageOrDechargeItem(aStack, 1, 1000, aPlayer)) {
                ...
                else aWorld.setBlockMetadataWithNotify(aX, aY, aZ, ~mColorMeta & 15, 3);
            }
            return true;
        }
