 ...
 * 
 * According to the Comment Field of the IToolCrowbar Interface, I need to look up for permission either at the
 * Railcraft Wiki or from CovertJaguar himself to use it.
 * It states at http://railcraft.wikispaces.com/License+%28Info%29 that: "The Railcraft API is released open source with
 * no restrictions on how you use or distribute it."
 * No restrictions means, that the Comment above the IToolCrowbar Interface is basically futile and just ensures that
 * one reads the Licence, even though I almost overlooked that Comment.
...
public class GT_CrowbarRC_Item extends GT_Crowbar_Item implements mods.railcraft.api.core.items.IToolCrowbar {
    ...
    public GT_CrowbarRC_Item(String aUnlocalized, int aMaxDamage, int aEntityDamage) {
        super(aUnlocalized, aMaxDamage, aEntityDamage);
    }
