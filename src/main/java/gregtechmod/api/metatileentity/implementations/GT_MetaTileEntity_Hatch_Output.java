...
public class GT_MetaTileEntity_Hatch_Output extends GT_MetaTileEntity_BasicTank {
    ...
    public GT_MetaTileEntity_Hatch_Output(int aID, String aName) {
        super(aID, aName);
    }
    ...
    public void onRightclick(EntityPlayer aPlayer) {
        getBaseMetaTileEntity().openGUI(aPlayer, 154, GregTech_API.gregtechmod);
    }
    ...
    public String getDescription() {
        return "metatileentity.GT_Output_Hatch.tooltip";
    }
