    ...
    public void onPostTick() {
        if (getBaseMetaTileEntity().isServerSide() && getBaseMetaTileEntity().getTimer() % 10 == 0) {
                ...
                if (tTileEntity != null) {
                    ...
                    if (tTileEntity instanceof IGregTechTileEntity) {
                        ...
                        if (((IGregTechTileEntity) tTileEntity).getMetaTileEntity()
                            .connectsToItemPipe(GT_Utility.getOppositeSide(i))) {
                            mConnections |= (1 << i);
                            continue;
                        }
                    }
                    ...
                    if (tTileEntity instanceof ISidedInventory) {
                        ...
                        int[] tSlots = ((ISidedInventory) tTileEntity)
                            .getAccessibleSlotsFromSide(GT_Utility.getOppositeSide(i));
            ...
            if (oLastReceivedFrom == mLastReceivedFrom && !isInventoryEmpty() && pipeCapacityCheck()) {
                ...
                Map<GT_MetaPipeEntity_Item, Long> tMap = GT_Utility.sortMapByValuesAcending(
                    GT_Utility.scanPipes(this, new HashMap<GT_MetaPipeEntity_Item, Long>(), 0, false));
        ...
        if (getBaseMetaTileEntity().getCoverBehaviorAtSide(aSide)
            ...
            if (tInventory != null && !(tInventory instanceof BaseMetaPipeEntity)) {
                if ((!(tInventory instanceof TileEntityHopper) && !(tInventory instanceof TileEntityDispenser))
                    ...
                    while (GT_Utility.moveOneItemStack(
                        aSender,
                        tInventory,
                        (byte) 6,
