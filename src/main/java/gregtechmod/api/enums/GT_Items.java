...
public enum GT_Items implements IItemContainer {
    ...
    public static final GT_Items[] SPRAY_CAN_DYES = { Spray_Color_00, Spray_Color_01, Spray_Color_02, Spray_Color_03,
    ...
    public Item getItem() {
        if (mHasNotBeenSet)
            throw new IllegalAccessError("The Enum '" + toString() + "' has not been set to an Item at this time!");
    ...
    public ItemStack getWildcard(long aAmount, Object... aReplacements) {
        ...
        if (GT_Utility.isStackInvalid(mStack)) return GT_Utility.copyAmount(aAmount, GT_Utility.cast(aReplacements));
        return GT_Utility
            .copyAmountAndMetaData(aAmount, GregTech_API.ITEM_WILDCARD_DAMAGE, GT_OreDictUnificator.get(mStack));
    }
