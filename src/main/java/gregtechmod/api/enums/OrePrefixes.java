...
public enum OrePrefixes {
    ...
    oreNether(true, true, false, false, false, -1), // Prefix of the Nether-Ores Mod. Causes Ores to double. Ore ->
                                                    // Material is a Oneway Operation!
    oreDense(true, true, false, false, false, -1), // Prefix of the Dense-Ores Mod. Causes Ores to double. Ore ->
                                                   // Material is a Oneway Operation!
    ...
    ore(true, true, false, false, false, -1), // Regular Ore Prefix. Ore -> Material is a Oneway Operation! Introduced
                                              // by Eloraam
    ...
    ingotDouble(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 2), // A double Ingot. Similar to the
                                                                                  // double Ingots of TerrafirmaCraft.
    ingotHot(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 1), // A hot Ingot, which has to be cooled
                                                                               // down by a Vacuum Freezer.
    ingot(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 1), // A regular Ingot. Introduced by Eloraam
    gem(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 1), // A regular Gem or crystallized Metal worth
                                                                          // one Dust. Introduced by Eloraam
    @Deprecated
    ...
    dustImpure(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 1), // Dust with impurities. 1 Unit of Main
                                                                                 // Material and 1/9 - 1/4 Unit of
                                                                                 // secondary Material
    ...
    dust(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 1), // Pure Dust worth of one Ingot or Gem.
                                                                           // Introduced by Alblaka.
    ...
    plateQuintuple(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 5), // Regular Plate made of one
                                                                                     // Ingot/Dust. Introduced by
                                                                                     // Calclavia
    plateQuadruple(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 4), // Regular Plate made of one
                                                                                     // Ingot/Dust. Introduced by
                                                                                     // Calclavia
    @Deprecated
    plateQuad(false, false, false, false, false, -1),
    plateTriple(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 3), // Regular Plate made of one
                                                                                  // Ingot/Dust. Introduced by Calclavia
    plateDouble(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 2), // Regular Plate made of one
                                                                                  // Ingot/Dust. Introduced by Calclavia
    plate(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 1), // Regular Plate made of one Ingot/Dust.
                                                                            // Introduced by Calclavia
    block(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 9), // Storage Block consisting out of 9
                                                                            // Ingots/Gems/Dusts. Introduced by
                                                                            // CovertJaguar
    stick(true, true, false, false, false, GregTech_API.MATERIAL_UNIT / 2), // Stick made of half an Ingot. Introduced
                                                                            // by Eloraam
    lense(true, true, false, false, false, (GregTech_API.MATERIAL_UNIT * 3) / 4), // 3/4 of a Plate or Gem used to shape
                                                                                  // a Lense. Normally only used on
    ...
    cellPlasma(true, true, true, true, false, GregTech_API.MATERIAL_UNIT * 1), // Hot Cell full of Plasma, which can be
                                                                               // used in the Plasma Generator.
    cell(true, true, true, true, false, GregTech_API.MATERIAL_UNIT * 1), // Regular Gas/Fluid Cell. Introduced by
                                                                         // Calclavia
    bucket(true, true, true, true, false, GregTech_API.MATERIAL_UNIT * 1), // A vanilla Iron Bucket filled with the
                                                                           // Material.
    ...
    slab(false, false, false, false, false, -1), // Prefix used for Slabs. Usually as "slabWood" or "slabStone".
                                                 // Introduced by SirSengir
    stair(false, false, false, false, false, -1), // Prefix used for Stairs. Usually as "stairWood" or "stairStone".
                                                  // Introduced by SirSengir
    ...
    tool(false, false, false, false, false, -1), // toolPot, toolSkillet, toolSaucepan, toolBakeware, toolCuttingboard,
    ...
    gearGt(true, true, false, false, false, GregTech_API.MATERIAL_UNIT * 4), // Introduced by me because BuildCraft has
                                                                             // ruined the gear Prefix...
    ...
    private final ArrayList<Materials> mNotGeneratedItems = new ArrayList<Materials>(),
        mIgnoredMaterials = new ArrayList<Materials>();
    ...
    private OrePrefixes(boolean aIsUnificatable, boolean aIsMaterialBased, boolean aIsSelfReferencing,
        boolean aIsContainer, boolean aDontUnificateActively, long aMaterialAmount) {
    ...
    public static void minimalItems() {
        ...
        if (GT_Mod.TF_loaded) integrateTF();
